...
description: Learn how you can target websites by domain or mobile apps using Targeting Lists Screen.  
ms.date: 10/28/2023
---
...
campaign, see [App Targeting](app-targeting.md).

## Choosing a list

1. Select **Network**\> **Inventory** \> **Targeting** Lists from the
    top navigation menu.
1. In the **Targeting Lists** section,
