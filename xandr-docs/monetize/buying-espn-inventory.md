...
description: Learn pointers to buy OTT inventory serving on ESPN Video On Demand on CTV or ESPN Live Streaming Video. 
ms.date: 10/28/2023
---
...
1. Upload the appropriate video creatives.
    ...
    For more information about how to upload video creatives, see [Add
    a Creative](add-a-creative.md) and [Add Creatives in Bulk](add-creatives-in-bulk.md).
