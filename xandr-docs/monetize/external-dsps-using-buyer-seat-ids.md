...
description: Verify DSP eligibility with Buyer Seat IDs, confirm migration status, and communicate for correct IDs. Ensure Microsoft Ads member IDs if seats are ineligible. 
ms.date: 10/28/2023
---
