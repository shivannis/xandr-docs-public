...
on how to set up publishers and placement tags in our system, see [Create a Publisher](create-a-publisher.md)
...
see [Working with Publishers](working-with-publishers.md).
...
instructions in [Export Placement Tags](export-placement-tags.md)
. This will provide you with display ad tags (`/ttj`). You'll
...
tags by hand that you export (see [Mobile SDKs](../mobile-sdk/xandr-mobile-sdks.md) for an alternate method).
For instructions on how to set up the `/mob` ad tag, see the section
**Mobile Tag Format** of the [Mobile Ad Call Reference](mobile-ad-call-reference.md).
...
- **Prerequisite** - You have already created the line item under which
  ...
  spend the money to make good on your agreement. See [Create a Standard Line Item](create-a-standard-line-item.md) for more details.
...
process for targeting specific placement tags is described in [Third-Party Inventory Targeting](third-party-inventory-targeting.md).
...
- **Daily** - This is the budget that you are willing to spend on any
  ...
  - **Pace Lifetime Budget** - Select this option to spread your
    ...
    details, examples, and best practices, see [Lifetime Pacing](lifetime-pacing.md).
...
area. For more details, see [Frequency and Recency Caps](frequency-and-recency-caps.md). Your campaign will show ads to users without
...
time. For more details, see [Associate Creatives to Campaigns](associate-creatives-to-campaigns.md).
...
campaign. For more details, see [Associate Creatives to Campaigns](associate-creatives-to-campaigns.md).
