...
<span class="notetitle">Note:</span> The `ANMultiAdRequest` instance
...
<thead class="thead">
<tr class="header ">
<th id="d28333e263" class="entry cellborder"
style="vertical-align: top">Variable</th>
<th id="d28333e266" class="entry cellborder"
style="vertical-align: top">Type</th>
<th id="d28333e269" class="entry cellborder"
style="vertical-align: top">Attributes</th>
<th id="d28333e272" class="entry cellborder"
style="vertical-align: top">Scope</th>
<th id="d28333e275" class="entry cellborder"
...
headers="d28333e263 "><code class="ph codeph">memberId</code></td>
<td class="entry cellborder"
headers="d28333e266 ">NSInteger</td>
<td class="entry cellborder"
headers="d28333e269 ">nonatomic, readonly, assign</td>
<td class="entry cellborder"
headers="d28333e272 ">Required</td>
<td class="entry cellborder"
headers="d28333e275 ">A member id. Any <code
...
<tr class="even ">
<td class="entry cellborder"
headers="d28333e263 "><code class="ph codeph">delegate</code></td>
<td class="entry cellborder"
headers="d28333e266 ">ANMultiAdRequestDelegate</td>
<td class="entry cellborder"
headers="d28333e269 ">nonnull</td>
<td class="entry cellborder"
headers="d28333e272 ">Required</td>
<td class="entry cellborder"
headers="d28333e275 ">An object to be notified with relevant callbacks
and information.</td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e263 "><code class="ph codeph">adUnits</code></td>
<td class="entry cellborder"
headers="d28333e266 ">List of adUnits</td>
<td class="entry cellborder"
headers="d28333e269 ">nonnull</td>
<td class="entry cellborder"
headers="d28333e272 ">Optional</td>
<td class="entry cellborder"
headers="d28333e275 ">A list of <code class="ph codeph">AdUnits</code>
for initialization of a <code
...
<span class="notetitle">Note:</span> If initialization is successful,
...
<thead class="thead">
<tr class="header ">
<th id="d28333e436" class="entry cellborder"
style="vertical-align: top">Parameter</th>
<th id="d28333e439" class="entry cellborder"
style="vertical-align: top">Type</th>
<th id="d28333e442" class="entry cellborder"
style="vertical-align: top">Attributes</th>
<th id="d28333e445" class="entry cellborder"
style="vertical-align: top">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e436 "><code class="ph codeph">memberId</code></td>
<td class="entry cellborder"
headers="d28333e439 ">NSInteger</td>
<td class="entry cellborder"
headers="d28333e442 ">readonly</td>
<td class="entry cellborder"
headers="d28333e445 ">A member id. Any <code
class="ph codeph">AdUnits</code> contained within the <code
class="ph codeph">MultiAdRequest</code> must have identical <code
class="ph codeph">memberIds</code> or the <code
...
<tr class="even ">
<td class="entry cellborder"
headers="d28333e436 "><code class="ph codeph">location</code></td>
<td class="entry cellborder"
headers="d28333e439 ">ANLocation</td>
<td class="entry cellborder"
headers="d28333e442 ">readwrite</td>
<td class="entry cellborder"
headers="d28333e445 ">The user location. <code
class="ph codeph">Location</code> can be set with <code
class="ph codeph">horizontalAccuracy</code> and a <code
...
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e436 "><code class="ph codeph">age</code></td>
<td class="entry cellborder"
headers="d28333e439 ">NSString</td>
<td class="entry cellborder"
headers="d28333e442 ">readwrite</td>
<td class="entry cellborder"
headers="d28333e445 ">The user's age.</td>
</tr>
<tr class="even ">
<td class="entry cellborder"
headers="d28333e436 "><code class="ph codeph">gender</code></td>
<td class="entry cellborder"
headers="d28333e439 ">ANGender</td>
<td class="entry cellborder"
headers="d28333e442 ">readwrite</td>
<td class="entry cellborder"
headers="d28333e445 ">The user's gender.</td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e436 "><code class="ph codeph">customKeyword</code></td>
<td class="entry cellborder"
headers="d28333e439 ">Array</td>
<td class="entry cellborder"
headers="d28333e442 ">readwrite</td>
<td class="entry cellborder"
headers="d28333e445 ">Custom keywords applied to the <code
...
<tr class="even ">
<td class="entry cellborder"
headers="d28333e436 "><code class="ph codeph">AdUnit</code></td>
<td class="entry cellborder"
headers="d28333e439 ">Object</td>
<td class="entry cellborder"
headers="d28333e442 ">readwrite</td>
<td class="entry cellborder"
headers="d28333e445 ">An <code class="ph codeph">AdUnit</code> item to
add to the <code class="ph codeph">MultiAdRequest</code></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e436 "><code class="ph codeph">countOfAdUnits</code></td>
<td class="entry cellborder"
headers="d28333e439 ">NSUintetger</td>
<td class="entry cellborder"
headers="d28333e442 ">readonly</td>
<td class="entry cellborder"
headers="d28333e445 ">Returns the number of <code
...
<thead class="thead">
<tr class="header ">
<th id="d28333e692" class="entry cellborder"
style="vertical-align: top">Parameter</th>
<th id="d28333e695" class="entry cellborder"
style="vertical-align: top">Type</th>
<th id="d28333e698" class="entry cellborder"
style="vertical-align: top">Scope</th>
<th id="d28333e701" class="entry cellborder"
style="vertical-align: top">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e692 "><code class="ph codeph">latitude</code></td>
<td class="entry cellborder"
headers="d28333e695 ">CGFloat</td>
<td class="entry cellborder"
headers="d28333e698 ">Required</td>
<td class="entry cellborder"
headers="d28333e701 ">The latitude of the location.</td>
</tr>
<tr class="even ">
<td class="entry cellborder"
headers="d28333e692 "><code class="ph codeph">longitude</code></td>
<td class="entry cellborder"
headers="d28333e695 ">CGFloat</td>
<td class="entry cellborder"
headers="d28333e698 ">Required</td>
<td class="entry cellborder"
headers="d28333e701 ">The longitude of the location.</td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e692 "><code class="ph codeph">timestamp</code></td>
<td class="entry cellborder"
headers="d28333e695 ">NSDate</td>
<td class="entry cellborder"
headers="d28333e698 ">Optional</td>
<td class="entry cellborder"
headers="d28333e701 ">The timestamp that the location was set.</td>
</tr>
<tr class="even ">
<td class="entry cellborder"
headers="d28333e692 "><code
...
headers="d28333e698 ">Required</td>
<td class="entry cellborder"
headers="d28333e701 ">The radius of uncertainty for the location.</td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d28333e692 "><code class="ph codeph">precision</code></td>
<td class="entry cellborder"
headers="d28333e695 ">NSInteger</td>
<td class="entry cellborder"
headers="d28333e698 ">Optional</td>
<td class="entry cellborder"
headers="d28333e701 ">Determines the decimal degree precision for the
location.</td>
</tr>
</tbody>
</table>
...
- **`load`** 
  ...
  <span class="ph">Xandr</span>'s Impression Bus. For each
...
- **`addAdUnit`** 
  ...
  **Arguments** 
  ...
  <thead class="thead">
  <tr class="header ">
  <th id="d28333e909" class="entry cellborder"
 >Parameter</th>
  <th id="d28333e912" class="entry cellborder"
 >Type</th>
  <th id="d28333e915" class="entry cellborder"
 >Scope</th>
  <th id="d28333e918" class="entry cellborder"
 >Description</th>
  </tr>
  </thead>
  <tbody class="tbody">
  <tr class="odd ">
  <td class="entry cellborder"
  headers="d28333e909 "><code class="ph codeph">AdUnit</code></td>
  <td class="entry cellborder"
  headers="d28333e912 ">Object</td>
  <td class="entry cellborder"
  headers="d28333e915 ">Required</td>
  <td class="entry cellborder"
  headers="d28333e918 ">An <code class="ph codeph">AdUnit</code> item to
  add to the <code class="ph codeph">MultiAdRequest</code></td>
  </tr>
  </tbody>
  </table>
...
- **`removeAdUnit`**
  ...
  **Arguments** 
  ...
  <thead class="thead">
  <tr class="header ">
  <th id="d28333e997" class="entry cellborder"
 >Parameter</th>
  <th id="d28333e1000" class="entry cellborder"
 >Type</th>
  <th id="d28333e1003" class="entry cellborder"
 >Scope</th>
  <th id="d28333e1006" class="entry cellborder"
 >Description</th>
  </tr>
  </thead>
  <tbody class="tbody">
  <tr class="odd ">
  <td class="entry cellborder"
  headers="d28333e997 "><code class="ph codeph">AdUnit</code></td>
  <td class="entry cellborder"
  headers="d28333e1000 ">Object</td>
  <td class="entry cellborder"
  headers="d28333e1003 ">Required</td>
  <td class="entry cellborder"
  headers="d28333e1006 ">An <code class="ph codeph">AdUnit</code> item to
  add to the <code class="ph codeph">MultiAdRequest</code></td>
  </tr>
  </tbody>
  </table>
...
- **`addCustomKeywordWithKey`** 
  ...
  **Arguments** 
  ...
  <thead class="thead">
  <tr class="header ">
  <th id="d28333e1081" class="entry cellborder"
 >Parameter</th>
  <th id="d28333e1084" class="entry cellborder"
 >Type</th>
  <th id="d28333e1087" class="entry cellborder"
 >Scope</th>
  <th id="d28333e1090" class="entry cellborder"
 >Description</th>
  </tr>
  </thead>
  <tbody class="tbody">
  <tr class="odd ">
  <td class="entry cellborder"
  headers="d28333e1081 "><code class="ph codeph">key</code></td>
  <td class="entry cellborder"
  headers="d28333e1084 ">NSString</td>
  <td class="entry cellborder"
  headers="d28333e1087 ">Required</td>
  <td class="entry cellborder"
  headers="d28333e1090 ">The key identifier for the custom keyword.</td>
  </tr>
  <tr class="even ">
  <td class="entry cellborder"
  headers="d28333e1081 "><code class="ph codeph">value</code></td>
  <td class="entry cellborder"
  headers="d28333e1084 ">NSString</td>
  <td class="entry cellborder"
  headers="d28333e1087 ">Required</td>
  <td class="entry cellborder"
  headers="d28333e1090 ">The value of the custom keyword.</td>
  </tr>
  </tbody>
  </table>
...
- **`removeCustomKeywordWithKey`** 
  ...
  **Arguments** 
  ...
  <thead class="thead">
  <tr class="header ">
  <th id="d28333e1181" class="entry cellborder"
 >Parameter</th>
  <th id="d28333e1184" class="entry cellborder"
 >Type</th>
  <th id="d28333e1187" class="entry cellborder"
 >Scope</th>
  <th id="d28333e1190" class="entry cellborder"
 >Description</th>
  </tr>
  </thead>
  <tbody class="tbody">
  <tr class="odd ">
  <td class="entry cellborder"
  headers="d28333e1181 "><code class="ph codeph">key</code></td>
  <td class="entry cellborder"
  headers="d28333e1184 ">NSString</td>
  <td class="entry cellborder"
  headers="d28333e1187 ">Required</td>
  <td class="entry cellborder"
  headers="d28333e1190 ">The key identifier for the custom keyword to be
  removed.</td>
  </tr>
  </tbody>
  </table>
...
<span class="notetitle">Note:</span> `[ANMultiAdRequest load]` can also
fail by returning `NO` even prior to sending a `UT Request`. if load
returns `YES` that means the `UT Request` was initiated, and all further
errors will come through the delegate method.
