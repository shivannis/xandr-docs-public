...
<span class="notetitle">Note:</span> To ensure a successful
...
<span class="ph">Xandr</span> SDK to render a native `Ad Reporting Flow`
on top of the ad. 
...
<span class="notetitle">Note:</span> Hold a reference to the request
...
<span class="ph">Xandr</span> has provided an <a
