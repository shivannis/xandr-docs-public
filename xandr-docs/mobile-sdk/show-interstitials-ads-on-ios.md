...
2.  When the ad content is actually received from the ad server, your
    ...
    impression to be counted by <span class="ph">Xandr</span>. (For the
    exact timing in milliseconds, see the value
    of `kANInterstitialAdTimeout` in the source code.)

<div id="ID-00002305__note_qqw_bpw_lwb" class="note">

<span class="notetitle">Note:</span> The close button appears after ten
seconds by default. You can set the delay
