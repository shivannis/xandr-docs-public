...
  Follow the instructions in this section to set up our SDK to show ads
in your app.
...
<span class="ph">Xandr</span> placement ID. This is a numeric ID that
...
<span class="tiptitle">Tip:</span> **Google Play**
...
as a dependency of your app. <span class="ph">Xandr</span>'s SDK will
...
<span class="tiptitle">Tip:</span> **Android Studio and Gradle**
...
- Install via Maven from your `build.gradle` file as shown below. Note
  ...
  <span class="notetitle">Note:</span> These are top-level blocks, not
...
<span class="warningtitle">Warning:</span> The compile command is no
...
<span class="tiptitle">Tip:</span> Location Permissions Must Prompt the
User
...
<span class="notetitle">Note:</span> The SDK will never wake up the
