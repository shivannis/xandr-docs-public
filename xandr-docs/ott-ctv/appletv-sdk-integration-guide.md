...
<span class="ph">Xandr</span>'s AppleTV SDK into your AppleTV
application, so you can use <span class="ph">Xandr</span>'s client-side
...
CocoaPods is used to distribute <span class="ph">Xandr</span>'s SDK and
...
**2. Import <span class="ph">Xandr</span>'s `AppleTV SDK` module into
UIViewController**
...
<span class="notetitle">Note:</span> To initialize the Apple TV SDK,
...
<thead class="thead">
<tr class="header ">
<th id="d168e389" class="entry cellborder"
style="text-align: left; vertical-align: top;">Parameter</th>
<th id="d168e392" class="entry cellborder"
style="text-align: left; vertical-align: top;">Data Type</th>
<th id="d168e395" class="entry cellborder"
...
headers="d168e389 ">widthOfAdIndicator</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Int?=nil</code></td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e395 ">The
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">leftMarginOfAdIndicator</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Int?=nil</code></td>
<td class="entry cellborder"
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">bottomMarginOfAdIndicator</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Int?=nil</code></td>
<td class="entry cellborder"
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">backgroundColor</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">heightOfAdIndicator</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Int?=nil</code></td>
<td class="entry cellborder"
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">alphaOfAdIndicator</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">widthOfAdCountdown</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Int?=nil</code></td>
<td class="entry cellborder"
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">heightOfAdCountdown</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Int?=nil</code></td>
<td class="entry cellborder"
...
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">isSkippable</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Bool?=nil</code></td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e395 ">Whether a skip button is displayed, allowing the
viewer to skip the ad. For example, true.</td>
</tr>
<tr class="even ">
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e389 ">disableSelectGestureOverride</td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;" headers="d168e392 "><code
class="ph codeph">Bool?=nil</code></td>
<td class="entry cellborder"
style="text-align: left; vertical-align: top;"
headers="d168e395 ">Whether the publisher app, not <span
class="ph">Xandr</span>, should control the remote trackpad's gesture
action. To let <span class="ph">Xandr</span> override the normal gesture
and enable a skip action, set this parameter to <code
class="ph codeph">false</code>. For example, true.</td>
</tr>
</tbody>
</table>
