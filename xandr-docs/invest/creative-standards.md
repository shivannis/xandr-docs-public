...
Microsoft Advertising has foundational policies that all
...
| Enabling or permitting piracy | - Copyright-infringing pirated media content<br> <li>Film/TV<br> <li> Books<br> <li> Music<br><li> Etc.<br> - File-sharing services without a DMCA (Digital Millennium Copyright Act) take-down policy |
...
serving on Microsoft Advertising inventory and recommendations for resolving the
...
to be approved. Microsoft Advertising reserves the right to update audit policies and
...
| Declared tag size does not match creative’s actual dimensions | Incorrect creative tag size. The size in Microsoft Advertising UI does not match the actual size of the creative. | - Check if the declared size in the UI matches your creative size. If not, please update the declared size to make it match with your creative size.<br><br> - In case of a high impact or expandable creative: It is recommended to upload and create the creative as a standard banner with 1x1 (or 1x2) size. This way, we won’t look at the primary size and will focus on the expandable creative size. |
...
- [General Guidelines for Passing Creative
  Audits](general-creative-guidelines-to-pass-auditing.md)
