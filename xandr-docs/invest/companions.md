...
description: Learn about Companions which is a type of creative that is supported on VAST version 2.0 and higher, and can be served with linear or non-linear creatives.
ms.date: 10/28/2023
---
