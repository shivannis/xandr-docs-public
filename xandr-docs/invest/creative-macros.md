...
description: This page covers places where creative macros can be used and different use cases pertaining to it. 
ms.date: 10/28/2023
---
...
- Impression trackers
- Creative landing page URLs specified at the creative or line item level
