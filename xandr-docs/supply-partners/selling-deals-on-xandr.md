# Selling Deals on <span class="ph">Xandr</span>

<div class="body">

<div class="note">

<span class="notetitle">Note:</span> You must be certified by
<span class="ph">Xandr</span> to sell deals on our platform. Please
contact <a href="https://help.xandr.com/" class="xref"
target="_blank">support</a> or your <span class="ph">Xandr</span>
representative to find out how to become certified.

</div>

  As a supply partner, you can use deals to provide
<span class="ph">Xandr</span> buyers special access to your inventory
...
Before you can add deals to <span class="ph">Xandr</span> and transact
...
2.  Understand the <a
    ...
    receiving bids from <span class="ph">Xandr</span>.
3.  Learn how to use <span class="ph">Xandr</span>'s API. See our <a
...
1.  Negotiate the deal with the <span class="ph">Xandr</span> buyer.
2.  Add the deal to your own system. 
3.  Ask the <span class="ph">Xandr</span> buyer for their
    <span class="ph">Xandr</span> member ID, which you will need in the
    next step.
...
## Step 2. Add the Deal to <span class="ph">Xandr</span>

<div class="note">

<span class="notetitle">Note:</span> This step shows you how to use
<span class="ph">Xandr</span>'s API to add a deal to
<span class="ph">Xandr</span> manually. However, we recommend building
an automated mechanism to sync your deals to
<span class="ph">Xandr</span> whenever they are created in your own
system.
...
2.  If the buyer did not give you their <span class="ph">Xandr</span>
    member ID, use the <a
...
1.  Use the
    ...
    <span class="ph">Xandr</span>. In your JSON POST, be sure to:
