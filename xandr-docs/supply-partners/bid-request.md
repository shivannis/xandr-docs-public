...
To send a bid request to <span class="ph">Xandr</span>, you `POST` a
...
<thead class="thead">
<tr class="header ">
<th id="d29773e107" class="entry cellborder"
style="vertical-align: top">Field</th>
<th id="d29773e110" class="entry cellborder"
style="vertical-align: top">Type</th>
<th id="d29773e113" class="entry cellborder"
...
headers="d29773e107 "><code class="ph codeph">an_user_id</code></td>
<td class="entry cellborder"
headers="d29773e110 ">int</td>
<td class="entry cellborder"
headers="d29773e113 ">The <span class="ph">Xandr</span> ID for the user
viewing the page. You include this field if you store user ID mappings
in your system. See <a
...
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">ext_user_id</code></td>
<td class="entry cellborder"
headers="d29773e110 ">string</td>
<td class="entry cellborder"
headers="d29773e113 ">The supply partner ID for the user viewing the
page. You include this field if you store user ID mappings with <span
class="ph">Xandr</span>. See <a
href="https://docs.xandr.com/bundle/supply-partners/page/user-id-mapping.html"
class="xref" target="_blank">User ID Mapping</a> for more details.
<p><strong>Required:</strong>yes, if <code
...
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">ext_auction_id</code></td>
<td class="entry cellborder"
headers="d29773e110 ">string</td>
<td class="entry cellborder"
headers="d29773e113 ">The supply partner ID for the auction. 
<p><strong>Required:</strong>yes</p></td>
</tr>
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">width</code></td>
<td class="entry cellborder"
headers="d29773e110 ">int</td>
<td class="entry cellborder"
headers="d29773e113 ">The width of the placement.
<p><strong>Required:</strong>yes</p></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">height</code></td>
<td class="entry cellborder"
headers="d29773e110 ">int</td>
<td class="entry cellborder"
headers="d29773e113 ">The height of the placement.
<p><strong>Required:</strong>yes</p></td>
</tr>
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">ad_format</code></td>
<td class="entry cellborder"
headers="d29773e110 ">enum</td>
<td class="entry cellborder"
headers="d29773e113 ">The format of the creative that should be
returned. Possible values: "iframe", "javascript", or "vast".
<strong>Note about VAST:</strong> The "vast" format is <strong>not
supported</strong>. However, see the VAST bid request in the <a
...
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">template_id</code></td>
<td class="entry cellborder"
headers="d29773e110 ">int</td>
<td class="entry cellborder"
headers="d29773e113 "><strong>Not yet supported</strong>. For VAST video
creatives, you may want <span class="ph">Xandr</span> to include custom
parameters in the <code class="ph codeph">ad_tag</code> field of the bid
response. To accomplish this, <span class="ph">Xandr</span> can create a
"supply template" for you, which you then reference here when requesting
VAST video. For more details, see <a
...
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">ip_address</code></td>
<td class="entry cellborder"
headers="d29773e110 ">string</td>
<td class="entry cellborder"
headers="d29773e113 ">The IP address for the user viewing the page.
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">is_secure</code></td>
<td class="entry cellborder"
headers="d29773e110 ">boolean</td>
<td class="entry cellborder"
headers="d29773e113 ">true or false. The supply partner can request an
SSL version of the creative by setting this to true.</td>
</tr>
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">page_url</code></td>
<td class="entry cellborder"
headers="d29773e110 ">string</td>
<td class="entry cellborder"
headers="d29773e113 ">The full domain of the bid request (do not pass an
encoded URL).
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">position</code></td>
<td class="entry cellborder"
headers="d29773e110 ">enum</td>
<td class="entry cellborder"
headers="d29773e113 ">The position of the placement on the page.
Possible values: "above" (above the fold), "below" (below the fold), or
"unknown".
...
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">ext_pub_code</code></td>
<td class="entry cellborder"
headers="d29773e110 ">string</td>
<td class="entry cellborder"
headers="d29773e113 ">The supply partner code for the publisher.
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code
class="ph codeph">ext_placement_code</code></td>
<td class="entry cellborder"
headers="d29773e110 ">string</td>
<td class="entry cellborder"
headers="d29773e113 ">The supply partner code for the placement.
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="even ">
<td class="entry cellborder"
...
headers="d29773e110 ">int</td>
<td class="entry cellborder"
headers="d29773e113 ">The <span class="ph">Xandr</span> ID for the
placement. To retrieve placement IDs, use the <a
...
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">language</code></td>
<td class="entry cellborder"
headers="d29773e110 ">int</td>
<td class="entry cellborder"
headers="d29773e113 ">The X ID for the language of the page. To retrieve
language IDs, use the <a
...
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">user_agent</code></td>
<td class="entry cellborder"
headers="d29773e110 ">string</td>
<td class="entry cellborder"
headers="d29773e113 ">The user agent for the request (i.e., the
browser).
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="odd ">
...
<td class="entry cellborder"
headers="d29773e110 ">array of ints </td>
<td class="entry cellborder"
headers="d29773e113 ">The <span class="ph">Xandr</span> IDs for the
creative technical attributes that are not permitted. To retrieve
technical attribute IDs, use the <a
...
headers="d29773e110 ">array of ints</td>
<td class="entry cellborder"
headers="d29773e113 ">The supply partner IDs for the creative technical
attributes that are not permitted.
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
...
<td class="entry cellborder"
headers="d29773e113 ">The <span class="ph">Xandr</span> IDs for the
creative categories that are not permitted. To retrieve category IDs,
use the <a
...
headers="d29773e110 ">array of ints</td>
<td class="entry cellborder"
headers="d29773e113 ">The supply partner IDs for the creative categories
...
<td class="entry cellborder"
headers="d29773e113 ">The <span class="ph">Xandr</span> IDs for the
content categories applied to the placement. You can use the <a
...
supply partner under its <span class="ph">Xandr</span> member.
<p><strong>Default:</strong>0</p>
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="even ">
...
headers="d29773e110 ">array of ints</td>
<td class="entry cellborder"
headers="d29773e113 ">The supply partner IDs for the content categories
applied to the placement.
<p><strong>Default:</strong>0</p>
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">blocked_urls</code></td>
<td class="entry cellborder"
headers="d29773e110 ">array of strings</td>
<td class="entry cellborder"
headers="d29773e113 ">The creative landing page URLs that are not
permitted. Up to 20 URLs can be blocked. Example formatting:
...
headers="d29773e110 ">array of ints </td>
<td class="entry cellborder"
headers="d29773e113 ">The creative languages that are not permitted. To
retrieve language IDs, use the <a
href="https://docs.xandr.com/bundle/xandr-api/page/language-service.html"
class="xref" target="_blank">Language Service</a>.
<p><strong>Required:</strong>no</p></td>
</tr>
...
<td class="entry cellborder"
headers="d29773e113 ">The <span class="ph">Xandr</span> IDs for the
brands that are not permitted. To retrieve brand IDs, use the <a
...
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">age</code></td>
<td class="entry cellborder"
headers="d29773e110 ">int</td>
<td class="entry cellborder"
headers="d29773e113 ">The age of the user viewing the page.
<p><strong>Default:</strong>0</p>
<p><strong>Required:</strong>no</p></td>
</tr>
<tr class="odd ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">gender</code></td>
<td class="entry cellborder"
headers="d29773e110 ">enum</td>
<td class="entry cellborder"
headers="d29773e113 ">The gender of the user viewing the page. Possible
...
<tr class="even ">
<td class="entry cellborder"
headers="d29773e107 "><code class="ph codeph">supply_type</code></td>
<td class="entry cellborder"
headers="d29773e110 ">enum</td>
<td class="entry cellborder"
headers="d29773e113 ">The display environment. Possible values: "web",
"mobile_app", "mobile_web", "in-stream-video", or "other".
<div class="note tip">
<span class="tiptitle">Tip:</span> The value of <code
...
<div class="note">
<span class="notetitle">Note:</span> The "in-stream-video" format is
...
<div id="ID-00004b1e__placement_mapping" class="section">

## Placement Mapping

<span class="ph">Xandr</span> will submit a bid only when we can map
your request to a placement in <span class="ph">Xandr</span>. We look up
...
If none of the above are available, <span class="ph">Xandr</span> will
not submit a bid. Note that each `ext_placement_code` can map to only
one placement in <span class="ph">Xandr</span>, and each `ext_pub_code`
can map to only one publisher in <span class="ph">Xandr</span>.

</div>

<div id="ID-00004b1e__examples_bid_request" class="section">
...
**Sending a bid request that includes <span class="ph">Xandr</span>
values only**

1.  Create a JSON-formatted file with the fields for
    <span class="ph">Xandr</span> values instead of supply partner
...
1.  Create a JSON-formatted file with the fields for supply partner
    values instead of <span class="ph">Xandr</span> values, for example,
...
- Do not pass `int_blocked_technical_attributes` or
  ...
  <span class="ph">Xandr</span> placement should define the allowed VAST
  video duration.
- If you have asked <span class="ph">Xandr</span> to set up a supply
...
1.  Create a JSON-formatted file according to the requirements above.
    ...
    <span class="ph">Xandr</span> system defined to allow VAST video
