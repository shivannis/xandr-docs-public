...
+ MS-5005 Added onAdImpression callback for the Banner and Interstitial Ads [https://docs.xandr.com/bundle/mobile-sdk/page/ios-sdk-ad-units.html]
...
+ MS-4710 Make bid price available as part of AdResponseInfo [https://docs.xandr.com/bundle/mobile-sdk/page/ad-response-info-class-for-ios.html].

+ MS-4759 Automatically pass Identifier for Vendors (IDFV) in Ad request. [https://docs.xandr.com/bundle/mobile-sdk/page/set-idfa-usage-for-ios.html]
...
+ MS-4802 ANSDKSettings.optionalSDKInitialization API [https://docs.xandr.com/bundle/mobile-sdk/page/initialize-sdk-settings-in-ios.html]
...
+ MS-4749 Added support for Unified ID 2.0 (UID2) [https://docs.xandr.com/bundle/mobile-sdk/page/user-id-s-mapping-on-ios.html]

+ MS-4760 Added support for Google Additional Consent field

+ MS-4772 Added a new API in ANMultiAdRequest to stop the Ad Request [https://docs.xandr.com/bundle/mobile-sdk/page/multi-ad-request-for-ios.html]

+ MS-4558 Added support for Swift Package Manager for SDK integration [https://docs.xandr.com/bundle/mobile-sdk/page/ios-sdk-integration-instructions.html]

+ MS-4784 Added XCFramework support for SDK integration [https://docs.xandr.com/bundle/mobile-sdk/page/ios-sdk-integration-instructions.html]
...
+ MS-4777 Added initialization check before fetching Bidder Token from Facebook SDK [https://docs.xandr.com/bundle/mobile-sdk/page/get-facebook-demand-for-native-on-ios.html]
...
+ MS-4659, MS-4674 Added support for User Id from external sources(Criteo, NetID, LiverRamp, The Trade Desk) [https://docs.xandr.com/bundle/mobile-sdk/page/user-id-s-mapping-on-ios.html]

+ MS-4657 Changes to support AppTrackingTransparency [https://docs.xandr.com/bundle/mobile-sdk/page/ios-14-0-faq.html]
...
+ externalUid property in ANAdProtocol has been deprecated, use publisherUserId in ANSDKSettings instead [https://docs.xandr.com/bundle/mobile-sdk/page/publisher-id-for-ios.html].
...
+ MS-4387 Added support to pass traffic source and external inventory codes in Ad Request [https://docs.xandr.com/bundle/mobile-sdk/page/support-to-pass-traffic-source-and-external-inventory-codes-in-ad-request-for-ios.html]

+ MS-4517 Added support for overriding Country and Zip Codes  [https://docs.xandr.com/bundle/mobile-sdk/page/support-for-overriding-country-and-zip-codes-for-ios.html]
...
+ MS-4412 Added support for listening to Ad Expiry events for Native Ads [https://docs.xandr.com/bundle/mobile-sdk/page/listener-for-adabouttoexpire-on-ios.html]

+ MS-4449 Added support for setting test flags to bypass request filtering (for testing purposes only)[https://docs.xandr.com/bundle/mobile-sdk/page/set-test-mode-for-ios.html]
...
+ MS-4433: Support for determining app-tracking permission status based on trackingAuthorizationStatus enum values (authorized, denied) [https://docs.xandr.com/bundle/mobile-sdk/page/ios-14-0-faq.html]
...
+ MS-4520: Rollback iOS 14 AppTrackingTransparency changes (Please refer https://docs.xandr.com/bundle/mobile-sdk/page/ios-14-0-faq.html for the latest updates on Xandr Mobile SDK's support for iOS 14)
...
+ MS-4433: Support for iOS 14 [https://docs.xandr.com/bundle/mobile-sdk/page/ios-14-0-faq.html]
...
+ MS-4361: Added onAdImpression callback for the Native Ads [https://docs.xandr.com/bundle/mobile-sdk/page/listen-to-native-ad-events-on-ios.html]
...
+ MS-4384: Added support for Auction timeout [https://docs.xandr.com/bundle/mobile-sdk/page/set-the-auction-timeout-for-ios.html]
...
+ MS-4214: Added support for loading the Ad lazily (Lazy Load) [https://docs.xandr.com/bundle/mobile-sdk/page/lazy-load-for-ios.html]
...
+ MS-3885 Added support for Multi Ad Request (MAR) [https://docs.xandr.com/bundle/mobile-sdk/page/multi-ad-request-for-ios.html]
...
+ MS-4097 California Consumer Privacy Act (CCPA) Support [https://docs.xandr.com/bundle/mobile-sdk/page/sdk-privacy-for-ios.html]
...
+ MS-3983: Added new API to Pause/Resume [https://docs.xandr.com/bundle/mobile-sdk/page/show-instream-video-ads-on-ios.html] VideoAd
...
+ FacebookAd SDK v5.5.1(has breaking changes, please look at Mediation Docs [https://docs.xandr.com/bundle/mobile-sdk/page/ios-mediation.html] for updated integration instruction)
...
**Some changes made in v6.0 are breaking and may require existing users who wish to upgrade from previous versions to follow our [migration guide.] [https://docs.xandr.com/bundle/mobile-sdk/page/ios-mediation.html]**
...
A list of supported versions of [third-party mediation networks] [https://docs.xandr.com/bundle/mobile-sdk/page/ios-mediation.html] is available in our public documentation
...
If you are currently using a static library version of AppNexus SDK(libANSDK.a) or a mediation adapter please follow our [migration guide] [https://docs.xandr.com/bundle/mobile-sdk/page/ios-mediation.html].
...
[https://docs.xandr.com/bundle/mobile-sdk/page/ios-mediation.html]
