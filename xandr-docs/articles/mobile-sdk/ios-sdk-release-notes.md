...
- MS-5197: Added iPad multiwindow support for Google AdMob mediation. Refer to [Mediate with iOS](mediate-with-ios.md) for more information.
...
2. Xandr will be moving toward counting "Viewable Impressions - for Direct-Sold Inventory" ([Github Issue #79](https://github.com/appnexus/mobile-sdk-ios/issues/79))
...
- MS-4520: Rollback iOS 14 AppTrackingTransparency changes (Please refer to [iOS 14.0 FAQ](ios-14-0-faq.md) for the latest updates on Xandr Mobile SDK's support for iOS 14)
...
- FacebookAd SDK v5.5.1 (has breaking changes, please look at [iOS Mediation](ios-mediation.md) for updated integration instruction)
...
> [!WARNING]
> If you are currently using a static library version of AppNexus SDK(libANSDK.a) or a mediation adapter please follow our [migration guide](ios-mediation.md).
...
- If you are currently using Static Library version of AppNexus SDK(libANSDK.a) / Mediation adapter please follow Migration Steps found [here](ios-mediation.md).
