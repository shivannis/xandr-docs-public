...
Description : Android SDK Release Notes
---
## 8.9
...
+ MS-5008 Added onAdImpression callback for the Banner and Interstitial Ads [https://docs.xandr.com/bundle/mobile-sdk/page/android-sdk-ad-units.html]
### Mediation partner updates
...
## 7.15
### New Feature
+ MS-4749 Add support for Unified ID 2.0 (UID2) [https://docs.xandr.com/bundle/mobile-sdk/page/user-id-s-mapping-on-android.html]
+ MS-4760 Added support for Google Additional Consent field
+ MS-4772 Exposed API in ANMultiAdRequest to stop the Ad Request [https://docs.xandr.com/bundle/mobile-sdk/page/multi-ad-request-for-android.html]
### Mediation partner updates
...
+ MS-4711 Exposed API in Native Custom element to support clickUrl and clickFallbackUrl for Native Ad [https://docs.xandr.com/bundle/mobile-sdk/page/listen-to-native-ad-events-on-android.html]
### Improvements/Bug Fixes
...
## 7.10
### New Feature
+ MS-4659, MS-4674 Added support for User Id from external sources(Criteo, NetID, LiverRamp, The Trade Desk) [https://docs.xandr.com/bundle/mobile-sdk/page/user-id-s-mapping-on-android.html]
### Improvements/Bug Fixes
+ MS-4671 Added minimum threshold of 100ms for callSetMraidRefreshFrequency
+ MS-4679 Fixed ad load issue (Github #59)
### Deprecated APIs
+ setExternalUid and getExternalUid methods in NativeAdRequest, VideoAd, BannerAdView, and InterstitialAdView classes are deprecated, use setPublisherUserId and getPublisherUserId in SDKSettings instead [https://docs.xandr.com/bundle/mobile-sdk/page/user-id-s-mapping-on-android.html]
...
## 7.8
### New Feature
+ MS-4387 Added support to pass traffic source and external inventory codes in Ad Request [https://docs.xandr.com/bundle/mobile-sdk/page/support-for-external-inventory-code-and-traffic-source-code-on-android.html]
+ MS-4567 Added support for overriding Country and Zip Codes  [https://docs.xandr.com/bundle/mobile-sdk/page/support-for-overriding-country-codes-and-zip-codes-on-android.html]
### Mediation partner updates
...
## 7.7
### New Feature
+ MS-4412 Added support for listening to Ad Expiry events for Native Ads [https://docs.xandr.com/bundle/mobile-sdk/page/listener-for-onadabouttoexpire-on-android.html]
+ MS-4449 Added support for setting test flags to bypass request filtering (for testing purposes only) [https://docs.xandr.com/bundle/mobile-sdk/page/set-test-mode-for-android.html]
...
## 7.6
### New Feature
+ MS-4232 Added support for executing the Ad request on background thread [https://docs.xandr.com/bundle/mobile-sdk/page/background-threading-on-android.html]
+ MS-4361 Added onAdImpression callback for the Native Ads [https://docs.xandr.com/bundle/mobile-sdk/page/listen-to-native-ad-events-on-android.html]
...
## 7.5
### New Features
+ MS-4384 Added support for Auction timeout [https://docs.xandr.com/bundle/mobile-sdk/page/set-the-auction-timeout-for-android.html]
### Improvements/Bug Fixes
...
## 7.4
### New Feature
+ MS-4214 Added (optional) support for lazy loading of AdUnits [https://docs.xandr.com/bundle/mobile-sdk/page/lazy-load-for-android.html]
### Improvements/Bug Fixes
...
## 7.0
### New Features
+ MS-3885 Added support for Multi Ad Request (MAR) [https://docs.xandr.com/bundle/mobile-sdk/page/multi-ad-request-for-android.html]

## 6.2
### New Features
+ MS-4097 California Consumer Privacy Act (CCPA) Support [https://docs.xandr.com/bundle/mobile-sdk/page/sdk-privacy-for-android.html]
...
## 6.1
### New Features
+ MS-4019: Added new API to Pause/Resume[https://docs.xandr.com/bundle/mobile-sdk/page/show-instream-video-ads-on-android.html] VideoAd

### Mediation partner upgrades
    + Smart Server SDK v7.2.0
    + FacebookAd SDK v5.5.0(has breaking changes, please look at Mediation Docs[https://docs.xandr.com/bundle/mobile-sdk/page/mediate-with-android-sdk.html] for updated integration instruction)
