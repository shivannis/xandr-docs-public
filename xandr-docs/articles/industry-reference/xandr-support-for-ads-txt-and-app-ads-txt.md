...
Description : <b>Warning:</b> The information in this
ms.date : 10/28/2023
...
<b>Warning:</b> The information in this
document is based on the latest
<a href="https://iabtechlab.com/ads-txt/" class="xref"
...
<b>Note:</b> For additional details about the
...
4.  For publisher direct seats, add a line to the file that looks like
   ...
   ![Publisher Direct Seats](media/publisher-direct-seats.png)
