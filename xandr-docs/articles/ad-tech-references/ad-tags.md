...
<img src="industry-reference/images/77269158.jpg" class="image"
...
4.  The ad server delivers the creative (the ad) to the browser.
    ...
    <a href="creatives.html" class="xref">Creatives: An Overview</a>.
...
For example, here's a <span class="ph">Xandr</span> ad tag that a
...
- The HTML `src=` tells the browser to retrieve content from the URL
  ...
  class="ph">adnxs</span>.com/ttj?id=1234</a>
- The URL points to the <span class="ph">Xandr</span> impression bus,
  which processes all requests to the <span class="ph">Xandr</span>
  platform. `/ttj` is a <span class="ph">Xandr</span> designation for a
  JavaScript call, and `id=1234` is the ID that
  <span class="ph">Xandr</span> has assigned to this ad tag. This allows
...
When the <span class="ph">Xandr</span> impression bus receives the tag,
