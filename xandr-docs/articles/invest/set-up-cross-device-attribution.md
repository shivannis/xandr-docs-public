...
4.  You can then run the **Analytics Report**
    ...
    title="Reporting on cross-device targeting and measurement is available in the MemberAnalytics report, the Device Analytics report, and the Data Usage report, as well as on the Analytics tab for the augmented line item.">Cross-Device
