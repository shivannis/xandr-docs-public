...
Exchange Rates are sourced once daily from [Oanda](https://www.oanda.com/) at approximately 3:00 a.m. UTC. All Xandr applications (bidder, budgeting, billing, etc.) use the [API Currency Service](../digital-platform-api/currency-service.md) (also available to
