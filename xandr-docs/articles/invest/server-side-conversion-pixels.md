...
1. The attribution server fires to Microsoft Advertising which includes the Conversion Pixel ID and the token. An example of this call would look like:  ```https://sspx-router.adnxs.com/sspx?id=1235&sspdata=ams1AAAAAAAAkQC8rFPull3JKKU9tUKckv1Oj1WFMAAAAAGULAAA3AAAAUQIAAD4AAA``` The ID parameter is the Microsoft Advertising’s ID of the pixel and SSPdata is the token.
