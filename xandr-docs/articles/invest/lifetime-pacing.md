...
Underspend catch-up allows you to dictate how Xandr's system deals with an underdelivered daily budget. Select **Evenly** if you'd like the unspent portions of your budget to be spent evenly throughout the rest of the flight, or **ASAP** if you'd like the unspent budget to be spent as soon as possible.
