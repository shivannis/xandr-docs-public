...
If you have set up third-party buying filters, only inventory in countries listed in both your third-party buying filters and line item
geography target settings will be targeted. If you target (include) geographies at the region, city, metro code, or postal code level,
Xandr will use these settings to derive the country target to be compared with your third-party buying filters.
