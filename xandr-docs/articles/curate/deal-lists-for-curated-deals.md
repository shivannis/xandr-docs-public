...
description: This article provides details on the deal lists for curated deals. A deal list is a group of deals IDs categorized for targeting across curated deal line items.
ms.date: 11/10/2023
---
...
1. Click **New** on the **Deal List** page and provide the following details in the **Create a New Deal List** page:
