...
The Microsoft Advertising video viewability measurement is based
...
To enable viewability measurement, Microsoft Advertising wraps
...
The Microsoft Advertising VPAID wrapper will always serve when
...
1. Consumer loads the website and the video ad tag makes a **bid
    request** to Microsoft Advertising servers.
1. The Microsoft Advertising server generates a **VAST
    document** that links to the Microsoft Advertising VPAID
...
1. The player loads, initializes, and **runs** the
    Microsoft Advertising **VPAID viewability wrapper**.
...
**Will viewability work on both Microsoft Advertising hosted
creatives and third-party hosted creatives?**

Yes, Microsoft Advertising provides viewability measurement
across all video creatives for free.

**What happens if I upload a VAST creative?**

Microsoft Advertising adds a VPAID viewability wrapper and will
...
Microsoft Advertising includes the VPAID viewability wrapper,
...
must first download the VPAID wrapper from Microsoft Advertising
...
**How does Microsoft Advertising viewability compare with other
third party viewability vendors such as MOAT, Integral Ad Science, and
DoubleVerify?**

The Microsoft Advertising viewability measurement aligns closely
