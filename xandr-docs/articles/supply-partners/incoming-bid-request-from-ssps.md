...
| `page` | string | Specifies the full URL of the page where the impression will be shown (for example, [page.publishersite.com/path/to/page](page.publishersite.com/path/to/page)). This should be the referrer URL and is preferred over the `domain` field. |
