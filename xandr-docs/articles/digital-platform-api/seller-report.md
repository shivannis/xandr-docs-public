...
| `geo_country` | enum | `"CA"` | A two-character string denoting the country in which the impression was viewed. For a complete listing of allowed values, see [ISO 3166-1 country codes](https://en.wikipedia.org/wiki/ISO_3166-1).<br><br>**Filter by**: Yes<br>**Sort by**: No<br><br>**Default**: `"--"` (This means "worldwide targeting, all countries included.") |
