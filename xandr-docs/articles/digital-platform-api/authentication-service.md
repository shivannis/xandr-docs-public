...
Note: For an explanation of the errors
that you may encounter during and after authentication, see <a
href="https://docs.xandr.com/bundle/xandr-api/page/api-semantics.html#APISemantics-ErrorMessages"
...
Note: For added security, it's also
possible to authenticate using JSON Web Tokens. See <a
href="https://docs.xandr.com/bundle/xandr-api/page/token-based-api-authentication.html"
...
Note: It is best practice to listen for
...
- <a href="account-recovery-service.html" class="xref">Account Recovery
  Service</a>
- <a
