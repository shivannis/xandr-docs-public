...
<b>Note:</b> `publisher_code` can be used in
...
href="payment-rule-service.md#PaymentRuleService-FilteredAdvertisers"
...
class="ph codeph">demand_filter_action</code> to. See <a
href="payment-rule-service.md#PaymentRuleService-FilteredLineItems"
...
you'd like to apply the action specified by <code
class="ph codeph">demand_filter_action</code> to. See <a
href="payment-rule-service.md#PaymentRuleService-FilteredCampaigns"
