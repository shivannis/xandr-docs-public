...
<b>Note:</b> The full timeout hierarchy in
...
href="https://docs.prebid.org/adops/price-granularity.md" class="xref"
...
the Xandr-<a
href="monetize_monetize-standard/currency-support.md"
