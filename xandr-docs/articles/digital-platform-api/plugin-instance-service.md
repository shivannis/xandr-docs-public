...
headers="ID-000005cb__entry__26">string</td>
<td class="entry colsep-1 rowsep-1" headers="ID-000005cb__entry__27">The
URL of the proxy.html file. This proxy file allows for cross-frame
...
$ cat plugin_instance.json
{
   "plugin-instance": {
       ...
       "proxy_url": "https://www.iframe_url.com/proxy.html"
   }
}
        ...
        "plugin-instances": [
            {
                ...
                "proxy_url": "https://host.appnexus/proxy_new.html"
            },
            {
                "id": 3,
                "plugin_id": 2,
                ...
                "proxy_url": "https://my.evidon.com/client_plugins/proxy.html"
            },
            {
                "id": 4,
                "plugin_id": 3,
                ...
                "proxy_url": "https://agents.proximic.com/appnexus/v1/proxy.html"
            },
            {
                "id": 5,
                "plugin_id": 4,
            ...
            },
            {
                ...
                "plugin_id": 5,
                "flavor": "standalone",
                "iframe_url": "https://e1.targusinfo.com/plugin/e1anx.html",
                "js_api_version": "",
                ...
                "icon_url": "https://targusinfo.com/files/images/16x16_T.jpg",
                "proxy_url": "https://e1.targusinfo.com/plugin/e1anxproxy.html"
            },
            {
                "id": 7,
                "plugin_id": 6,
                ...
                "proxy_url": "https://marketplace.brilig.com/brilig-webapp/proxy.html"
            },
            ...
        ],
        "dbg_info": {
...
$ curl -b cookies -c cookies 'https://api.appnexus.com/plugin-instance?id=32'
{
    "response": {
        ...
        "plugin-instance": {
            ...
            "proxy_url": "https://apps.eyereturn.com/appnexusproxy.html"
        },
        "dbg_info": {
            ...
        }
