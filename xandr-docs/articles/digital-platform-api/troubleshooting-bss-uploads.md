...
<div id="buy-side-service-template__TroubleshootingBSSUploads-DifferentPhasesofBatchSegmentService"
>
...
<div id="buy-side-service-template__section_xrx_xmd_vwb"
>
...
<div id="buy-side-service-template__TroubleshootingBSSUploads-ViewYourFileUploadHistory"
>
...
`batch_segment_upload_job` object, see <a
href="troubleshooting-bss-uploads.html#buy-side-service-template__section_bdk_zld_vwb"
class="xref">JSON Fields</a>.

<div id="buy-side-service-template__note_tp2_p2d_vwb"
...
<div id="buy-side-service-template__note_oxl_s2d_vwb"
...
<div id="buy-side-service-template__section_bdk_zld_vwb"
>

## **JSON Fields**

<table id="buy-side-service-template__table_chq_w2d_vwb" class="table">
<thead class="thead">
<tr class="header row">
<th id="buy-side-service-template__table_chq_w2d_vwb__entry__1"
class="entry colsep-1 rowsep-1">HTTP Method</th>
<th id="buy-side-service-template__table_chq_w2d_vwb__entry__2"
class="entry colsep-1 rowsep-1">Endpoint</th>
<th id="buy-side-service-template__table_chq_w2d_vwb__entry__3"
...
headers="buy-side-service-template__table_chq_w2d_vwb__entry__1"><code
class="ph codeph">GET</code></td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_chq_w2d_vwb__entry__2"><a
href="https://api.appnexus.com/batch-segment/meta" class="xref"
target="_blank">https://api.appnexus.com/batch-segment/meta</a></td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_chq_w2d_vwb__entry__3">Use
this call to find out which fields you can filter and sort by.</td>
</tr>
</tbody>
</table>

<table id="buy-side-service-template__table_dhq_w2d_vwb" class="table">
<thead class="thead">
<tr class="header row">
<th id="buy-side-service-template__table_dhq_w2d_vwb__entry__1"
class="entry colsep-1 rowsep-1">Fields</th>
<th id="buy-side-service-template__table_dhq_w2d_vwb__entry__2"
class="entry colsep-1 rowsep-1">Type</th>
<th id="buy-side-service-template__table_dhq_w2d_vwb__entry__3"
class="entry colsep-1 rowsep-1">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_dhq_w2d_vwb__entry__1"><code
class="ph codeph">id</code></td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_dhq_w2d_vwb__entry__2">int</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_dhq_w2d_vwb__entry__3"><p>This
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_dhq_w2d_vwb__entry__2">string</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_dhq_w2d_vwb__entry__3">The
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_dhq_w2d_vwb__entry__2">object</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_dhq_w2d_vwb__entry__3">This is
an object whose fields contain metadata describing the upload and
processing job. If you are using the Impbus API, this will be an array
containing a single object. See <a
href="troubleshooting-bss-uploads.html#buy-side-service-template__p_px1_ly3_gyb"
...
<div id="buy-side-service-template__note_el3_5y3_gyb"
...
<table id="buy-side-service-template__table_u3v_z2d_vwb" class="table">
<thead class="thead">
<tr class="header row">
<th id="buy-side-service-template__table_u3v_z2d_vwb__entry__1"
class="entry colsep-1 rowsep-1">Fields</th>
<th id="buy-side-service-template__table_u3v_z2d_vwb__entry__2"
class="entry colsep-1 rowsep-1">Type</th>
<th id="buy-side-service-template__table_u3v_z2d_vwb__entry__3"
class="entry colsep-1 rowsep-1">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
class="ph codeph">upload_url</code></td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">string</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
URL where you'll upload your segment data file.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">enum</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
current processing status.</p>
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">date</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
time at which file upload began.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
time at which the file associated with this job ID was
uploaded.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
time at which file validation was completed.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
time at which file processing was completed.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">int</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>If
<code class="ph codeph">"phase": "error"</code>, this error code
describes the type of error encountered. Note that an error code will
only be shown here if there was an error with the uploading, validating,
or processing of the file itself (i.e., does not include invalid format
or invalid segment errors). Common errors are caused by unreadable files
and exceeding defined object limits.</p>
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">decimal</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
time it took to process the segment file, in minutes.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<code class="ph codeph">phase</code> at the time of the
request.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
...
combination is considered 1 line.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
considered an invalid format.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">int</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>A
count of unique input lines that have a valid user ID.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>A
count of unique input lines that have an invalid or non-existent
user.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
number of invalid segments in the file. Deduplicated.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
number of invalid timestamps in the file.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
number of expired segments in the file. Deduplicated.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
number of inactive segments in the file. Deduplicated.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">int</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>This
is a placeholder value not currently in use.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
error or the reason for an error while uploading your file.</p>
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>A
string containing newline-separated lines consisting of the segment ID
and the number of users successfully added or removed. This field
defaults to 200 lines.</p>
...
by <code class="ph codeph">COUNT</code> (descending).</p>
<p>Example:</p>
<pre class="pre codeblock"><code>added:15889133:38622115547290:186227removed:15889278:36973415889206:25530715889179:232831</code></pre></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
unique identifier of this object.</p></td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
processing job associated with this file.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__2">int</td>
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>Your
member ID.</p>
...
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__3"><p>The
creation date of this object.</p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="buy-side-service-template__table_u3v_z2d_vwb__entry__1"><code
...
<div id="buy-side-service-template__section_pdv_cmd_vwb"
>
