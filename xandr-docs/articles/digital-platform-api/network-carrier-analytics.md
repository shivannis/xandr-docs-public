...
`"network_carrier_analytics"`, as well as the columns (dimensions and
...
want to see how campaigns are performing on mobile phones and tablets
across three specific carriers. Specifically, for each combination of
carrier and device type, we want the number of impressions, the number
of clicks, the total money spent, the money spent per 1000 impressions,
the money paid to us by the advertiser, and the total profit (money
earned - money spent).
...
<div id="report_api_template__note_o1b_wdb_wwb"
...
<div id="report_api_template__section_b1r_zdb_wwb"
>
