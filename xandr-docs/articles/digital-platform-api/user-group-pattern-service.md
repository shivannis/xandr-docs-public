...
<b>Note:</b> It is important to note that a
...
3.  The response includes `usergroup_target` values for your pattern.
    ...
    <a href="profile-service.md" class="xref">Profile Service</a> for
    more details).
...
href="profile-service.md" class="xref">profile</a>. See the example
