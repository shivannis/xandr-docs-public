...
<div id="buy-side-service-template__note_n2c_lkq_5wb"


Note: The shared "birthday cookie"
...
<div id="buy-side-service-template__note_cqc_nkq_5wb"
class="note tip note_tip">

Tip: Once you have a segment ID, the
basic format of a segment pixel is
`<img src="https://ib.adnxs.com/seg?add=123" width="1" height="1"/>`,
where `123`
...
<div id="buy-side-service-template__note_ryq_pkq_5wb"
...
(segment JSON)
<div id="buy-side-service-template__note_yd1_nlq_5wb"
class="note tip note_tip">
Tip: To change a segment from
...
href="https://docs.xandr.com/bundle/xandr-api/page/segment-service.html#SegmentService-Examples"
...
<div id="buy-side-service-template__note_mk5_dmq_5wb"
...
<div id="buy-side-service-template__note_dvd_hmq_5wb"
class="note note_note">
Note: When switching a segment from
...
<div id="buy-side-service-template__note_zcq_kmq_5wb"
class="note note_note">
Note:
...
<div id="buy-side-service-template__note_w4m_mmq_5wb"
class="note note_note">
Note: Invalid, if <code
...
<a
href="https://docs.xandr.com/bundle/xandr-api/page/segment-service.html#SegmentService-PiggybackPixels"
...
<div id="buy-side-service-template__note_mnp_smq_5wb"
class="note note_note">
Note:
...
<div id="buy-side-service-template__note_a5s_tmq_5wb"
class="note note_note">
Note: The parent-child logic extends
...
a segment. See <a
href="https://docs.xandr.com/bundle/xandr-api/page/segment-service.html#SegmentService-AboutQueryStrings"
class="xref" target="_blank">About Query Strings</a> for a general
description of query strings and <a
href="https://docs.xandr.com/bundle/xandr-api/page/segment-service.html#SegmentService-QueryStringMapping"
...
class="xref" target="_blank">About Query Strings</a> for a general
description of query strings and <a
href="https://docs.xandr.com/bundle/xandr-api/page/segment-service.html#SegmentService-QueryStringMappingKeyValue"
class="xref" target="_blank">Query String Mapping Key Value</a> for more
details.
<div id="buy-side-service-template__note_b1k_zmq_5wb"
class="note note_note">
Note:
<ul>
...
<div id="buy-side-service-template__note_x3j_pnq_5wb"
class="note tip note_tip">
Tip:
