...
<b>Warning:</b> The resources listed on this
...
<b>Note:</b> When you specify a <code
...
class="note note_note">
<b>Note:</b> seg_ttl versus expiry
...
<b>Note:</b> Where the segment has a known
...
<b>Note:</b> Although any valid OLC code will
...
<b>Note:</b> This RTSS functionality is no
...
<b>Note:</b> Take care when adding or deleting
...
<b>Note:</b> Uploaded IDs are converted to
...
<b>Note:</b> Given the resources required to
...
class="note note_note">
<b>Note:</b> Postal codes targets will be
deprecated soon
...
Please see <a
href="https://docs.xandr.com/csh?context=166638255&amp;topicname=rtss-best-practices.md#RTSSBestPractices-BulkUploads"
