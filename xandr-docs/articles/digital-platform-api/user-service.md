...
<div id="ID-00003332__user_types" >

## User Types



Note: Once a user has been created, the
...
Note: The username should not contain
...
<p>See <a href="user-service.html#ID-00003332__user_types"
...
Note: This field cannot be modified on
...
href="member-service.html" class="xref">member</a></p></td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
headers="ID-00003332__entry__58"><code
...
Note: This field controls how the user
...
Note: This setting controls how the
...
on the <a href="member-service.html" class="xref">Member Service</a>.
<p><strong>Default</strong>: <code
class="ph codeph">"false"</code> </p></td>
</tr>
<tr class="odd row">
