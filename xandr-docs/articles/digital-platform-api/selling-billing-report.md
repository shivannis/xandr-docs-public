...
| `deal_type` | string | Yes | `"Open Auction"` | The deal type for a particular deal. Deal type options are: <br> - `Open Auction` <br> - `Private Auction` - `Curated` <br> - `First Look` <br> - `Programmatic Guaranteed` |
