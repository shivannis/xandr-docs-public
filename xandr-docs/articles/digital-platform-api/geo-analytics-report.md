...
see <a href="geo-analytics-report.md#geo-analytics-report__dimensions"
class="xref">Dimensions</a> and
<a href="geo-analytics-report.md#geo-analytics-report__metrics"
class="xref">Metrics</a> below.

For instructions on running this report, see the
<a href="geo-analytics-report.md#geo-analytics-report__example"
class="xref">Example</a>.



<b>Note:</b> **On the accuracy of determining
...
<b>Note:</b> <strong>Why am I seeing a DMA ID
of 1?</strong>
