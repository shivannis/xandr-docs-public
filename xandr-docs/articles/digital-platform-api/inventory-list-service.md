...
| `inventory_list_type` | enum | **Required On:** `POST`<br>Type of inventory list. Possible values:<br><br>**Note:** Going forward, "allowlist" and "blocklist" terminology will be followed for our APIs. This is a part of an ongoing effort to evaluate our current terminology usage and usher in more inclusive terminology for Xandr platforms.<br> - `whitelist`<br> - `blacklist`<br><br>**Note:** The value of this field cannot be edited on `PUT` calls. |
