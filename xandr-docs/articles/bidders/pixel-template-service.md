...
|:---|:---|:---|
| GET | https://api..com/pixel-template | To view all Xandr-approved creative pixels. |
| GET | https://api..com/pixel-template/PIXEL_TEMPLATE_ID | To view a specific Xandr-approved creative pixel. |
