...
| `accepted_languages` | some  | string | The "Accept-Language" header from the browser (using [ISO-639](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language and [ISO-3166](https://en.wikipedia.org/wiki/ISO_3166-1) country codes). |
