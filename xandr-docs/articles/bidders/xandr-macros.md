...
<b>Tip:</b> For more control over URL encoding
and decoding, see the section on <a
href="xandr-macros.md#XandrMacros-FunctionMacros"
...
<b>Warning:</b> OpenRTB macros (like
...
<b>Note:</b> This field is deprecated (as of
...
<b>Note:</b> Each encoding corresponds to a
