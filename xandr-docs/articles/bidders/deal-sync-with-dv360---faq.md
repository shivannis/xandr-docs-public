...
UI. We are working to display the DV360 buyer acceptance status in
 and plan to release the feature in future
iterations of this product.
...
<tbody class="tbody">
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"><ul>
<li>Deal Name</li>
</ul>
<ul>
<li>Buyer Seat ID</li>
...
While multi format deals are supported in Monetize UI, DV360 does
encourage publishers to declare only one media type in a deal. This will
...
the <a href="dv360-buyer-ui-deal-acceptance-workflows.html"
class="xref">DV360 Buyer UI Deal Acceptance Workflows</a> document with
their buyers, which explains in more detail how to accept a deal in the
DV360 UI as well as how to target creatives and line items to an
accepted deal.
...
purposes. Therefore pacing will largely be determined based on the
