...
the <a href="safeframe-api-reference.md" class="xref">SafeFrame API
Reference</a>.</td>
</tr>
<tr class="even row">
<td class="entry colsep-1 rowsep-1"
...
<b>Note:</b> you need to have the AST debug
...
<b>Note:</b> For more details about `userSync`
...
- 
  ...
  <b>Note:</b> The request-building process is
