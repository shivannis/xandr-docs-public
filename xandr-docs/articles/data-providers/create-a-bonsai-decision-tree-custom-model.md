...
Description : The Digital Platform API empowers you to create your own custom
...
Note: The Alpha workflow requires using
...
- Be sure to take advantage of reporting data in identifying the right
  ...
  - <a
    ...
    required)
  - <a href="log-level-data-feeds.html" class="xref">Log-Level Data
    Feeds</a> (customer login required)

Example: Decision tree for bid pricing

<img src="data-science-toolkit/images/116524622.png" class="image" />
...
- If there are errors, use the `error` field in the response to help you
  ...
  href="https://docs.xandr.com/bundle/data-science-toolkit/page/custom-model-parser-service.html#CustomModelParserService-ErrorMessages"
...
Note: If the tree is larger than 3MB,
