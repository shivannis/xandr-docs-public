...
Description : ## Member Data Sharing Service (For audience data providers only)
ms.custom : data-providers
ms.date : 10/28/2023
<b>Tip:</b> In order to make the Member Data
...
<b>Tip:</b> If you have custom segments
intended for specific members, you should set `segment_exposure` to
"list" in each sharing record and use the `segments` array to identify
the segments that each member should have access to.





<b>Note:</b> The Member Data Sharing service
works on BOTH Xandr's API
(api.appnexus.com) as well as the impression bus
API (api.adnxs.com). Although only
api.adnxs.com is used below, it may be replaced
with api.appnexus.com for those clients who have
access to Xandr's API. Only members who are on
Xandr will have access to the API. The majority
...
<thead class="thead">
<tr class="header row">
<th id="ID-000011f9__entry__1" class="entry">HTTP Method</th>
<th id="ID-000011f9__entry__2" class="entry">Endpoint</th>
<th id="ID-000011f9__entry__3" class="entry">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry" headers="ID-000011f9__entry__1">GET</td>
<td class="entry" headers="ID-000011f9__entry__2"><a
href="https://api.adnxs.com/member-data-sharing" class="xref"
target="_blank">https://api.<span
class="ph">adnxs.com/member-data-sharing</a></td>
<td class="entry" headers="ID-000011f9__entry__3">View all of your
sharing records</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000011f9__entry__1">GET</td>
...
class="ph">adnxs.com/member-data-sharing/RECORD_ID</a></p>
<p>If you don't know the record ID, you can use below endpoint<br />
<a
href="https://api.adnxs.com/member-data-sharing?data_member_id=MEMBER_ID&amp;buyer_member_id=CLIENT_MEMBER_ID"
class="xref" target="_blank">https://api.<span
class="ph">adnxs.com/member-data-sharing?data_member_id=MEMBER_ID&amp;buyer_member_id=CLIENT_MEMBER_ID</a></p></td>
<td class="entry" headers="ID-000011f9__entry__3">View a specific
sharing record</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000011f9__entry__1">POST</td>
<td class="entry" headers="ID-000011f9__entry__2"><a
href="https://api.adnxs.com/member-data-sharing" class="xref"
target="_blank">https://api.<span
class="ph">adnxs.com/member-data-sharing?data_member_id=MEMBER_ID</a><br />
(sharing JSON)</td>
<td class="entry" headers="ID-000011f9__entry__3">Add one sharing record
...
(sharing JSON)</td>
<td class="entry" headers="ID-000011f9__entry__3">Add multiple sharing
records
...
<tr class="odd row">
<td class="entry" headers="ID-000011f9__entry__1">PUT</td>
<td class="entry" headers="ID-000011f9__entry__2"><a
href="https://api.adnxs.com/member-data-sharing/RECORD_ID" class="xref"
target="_blank">https://api.<span
class="ph">adnxs.com/member-data-sharing?id=RECORD_ID</a><br />
(sharing JSON)
<p><a href="https://api.adnxs.com/member-data-sharing/RECORD_ID"
class="xref" target="_blank">https://api.<span
class="ph">adnxs.com/member-data-sharing/RECORD_ID</a><br />
(sharing JSON)</p></td>
<td class="entry" headers="ID-000011f9__entry__3">Modify a sharing
record</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000011f9__entry__1">DELETE</td>
<td class="entry" headers="ID-000011f9__entry__2"><a
href="https://api.adnxs.com/member-data-sharing/RECORD_ID" class="xref"
target="_blank">https://api.<span
class="ph">adnxs.com/member-data-sharing?id=RECORD_ID</a>
<p><a href="https://api.adnxs.com/member-data-sharing/RECORD_ID"
class="xref" target="_blank">https://api.<span
class="ph">adnxs.com/member-data-sharing/RECORD_ID</a></p></td>
<td class="entry" headers="ID-000011f9__entry__3">Delete a sharing
record</td>
</tr>
</tbody>
</table>
...
href="member-data-sharing-service-audience-only.md#ID-000011f9__audience_only_examples"
...
<thead class="thead">
<tr class="header row">
<th id="ID-000011f9__entry__22" class="entry">Field</th>
<th id="ID-000011f9__entry__23" class="entry">Type (Length)</th>
<th id="ID-000011f9__entry__24" class="entry">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry" headers="ID-000011f9__entry__22">id</td>
<td class="entry" headers="ID-000011f9__entry__23">int</td>
<td class="entry" headers="ID-000011f9__entry__24">The ID of the sharing
record.
<p><strong>Default</strong>: Auto-generated number<br />
<strong>Required On</strong>: PUT/DELETE, in query string</p></td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000011f9__entry__22">data_member_id</td>
<td class="entry" headers="ID-000011f9__entry__23">int</td>
<td class="entry"
headers="ID-000011f9__entry__24"><strong>Read-only</strong>. Your member
ID.</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000011f9__entry__22">buyer_member_id</td>
<td class="entry" headers="ID-000011f9__entry__23">int</td>
<td class="entry" headers="ID-000011f9__entry__24">The ID of the member
with whom you are sharing segments.
<p><strong>Required On</strong>: POST</p></td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000011f9__entry__22">segment_exposure</td>
<td class="entry" headers="ID-000011f9__entry__23">enum</td>
<td class="entry" headers="ID-000011f9__entry__24">Whether you share all
...
<tr class="odd row">
<td class="entry" headers="ID-000011f9__entry__22">segments</td>
<td class="entry" headers="ID-000011f9__entry__23">array of objects</td>
<td class="entry" headers="ID-000011f9__entry__24">If segment_exposure
...
<b>Note:</b> In this example, the PUT request
