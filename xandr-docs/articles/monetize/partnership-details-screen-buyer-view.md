...
For more information on seller eligibility and
inventory trust settings, see
...
for the seller, your default settings will apply. For more information
on setting default settings, see
<a href="set-seller-defaults.md" class="xref">Set Seller Defaults</a>.
...
- URLs - If domains are exposed, you
  ...
  For more information on targeting URLs, see
...
- Categories (Universal) or
  ...
  categories. For more information on targeting content
  categories, see
...
- Age or Gender - If age or gender
  ...
  For more information on targeting age or gender, see
...
For step-by-step instructions on editing a seller's
settings, see
...
<a href="get-deals-from-seller-packages.md" class="xref">Get Deals
from Seller Packages</a> for more information.
