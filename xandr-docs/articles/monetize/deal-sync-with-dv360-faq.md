...
1. If the deal details of the deal created via API does not match the
...
1. If the deal type of the deal created via API upload differs from the
...
Publishers can share the [DV360 Buyer UI Deal Acceptance Workflows](dv360-buyer-deal-acceptance-wf.md) document with their buyers, which
