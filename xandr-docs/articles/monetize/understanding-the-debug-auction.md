...
| Action | URL |
|---|---|
| View Xandr cookie | `https://ib.adnxs.com/cookie?member_id=MEMBER_ID&dongle=DONGLE` <br> where `MEMBER_ID` is your member ID, `DONGLE` is your member-specific dongle |
