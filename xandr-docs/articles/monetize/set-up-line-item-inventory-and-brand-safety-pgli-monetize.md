...
1.  Set **Managed Inventory**.
    a. This setting controls targeting inventory by universal or custom content categories, as well as how you target direct inventory. See [Inventory Targeting](inventory-targeting-pgli.md) for more details.
