...
Note: If you'd like to buy from other
...
Note: When you set up your placement
...
class="xref">device-and-supply-type-targeting.html</a> for more details.
...
see <a href="working-with-publishers.html" class="xref">Working with
Publishers</a>.
...
Note: For mobile campaigns, **system
...
or wifi/static). See
<a href="system-targeting.html" class="xref">System Targeting</a> for
details.
...
Note: Since you are creating and
...
- **Flight Dates** - Set the start for the campaign and set an end date
  ...
  for the campaign. Note: of flight dates are set for the parent line
...
Note: you can set budgets at the
...
- **Enable Roadblocking** - In cases where your managed publishers are
  ...
  Important: Roadblocking is available
...
See <a href="peer-approval.html" class="xref">Peer Approval</a> for more
information.
