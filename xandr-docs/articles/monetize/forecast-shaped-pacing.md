...
To summarize: FSP takes into account the variability of inventory throughout the day, setting hourly delivery goals that map to high-fidelity, line-item specific forecasts powered by the [Yieldex Forecasting Engine](https://wiki.xandr.com/display/YieldexAnalytics).
