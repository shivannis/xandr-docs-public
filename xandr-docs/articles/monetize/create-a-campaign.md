...
on mobile apps. For instructions on creating a campaign to run on deals,
see <a href="create-a-deal-campaign.html" class="xref">Create a Deal
Campaign</a>.
...
Important: One of the main reasons that
...
Note: You can use the search field to
...
Important: If flight dates are set for
...
Tip: To further limit serving to
...
- **Unlimited** - Select this option to leave your lifetime budget
  ...
  Note: If **Lifetime** budget is set
...
- **Daily** - This is the budget that you are willing to spend on any
  ...
  - **Pace evenly throughout the day** - Select this option, otherwise
    ...
    <a href="daypart-targeting.html" class="xref">Daypart Targeting</a>
    or <a href="daily-pacing.html" class="xref">Daily Pacing</a>.
...
Note: If you have enabled the unlimited
...
- <a href="create-a-campaign.html#ID-0000263e__p_ibm_qq5_1kb"
  class="xref">Buy Direct Inventory</a>
- <a href="create-a-campaign.html#ID-0000263e__p_ujd_rq5_1kb"
...
- **Campaign Priority** - Since you have already paid for direct
  ...
  Tip: By default, campaign priority
...
Note: If roadblocking has been set at
...
Warning: Mobile Conversion Tracking
...
- To learn about setting up Performance Goals on the line item, see Step
  6 of <a href="create-a-standard-line-item.html" class="xref">Create a
...
- - **Optimize to a % margin of booked revenue** - Use this strategy to
  ...
  - **Optimize to a predicted CPA goal** - Use this strategy to vary
    ...
    - **Learn Budget** - The learn budget is the portion of your
      ...
      see <a href="targeted-learn.html" class="xref">Targeted Learn</a>.
...
Tip: If using frequency targeting for
...
See <a
href="creative-rotation-standard-line-item-and-guaranteed-delivery-line-item.html"
class="xref"
...
details, see <a href="dynamic-landing-pages.html" class="xref"
...
Tip: If you prefer, you can associate
...
Tip: When activated for a user at the
...
Note: This step applies only to clients
...
Note: The campaign peer approval
