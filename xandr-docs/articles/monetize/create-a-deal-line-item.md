...
<a href="create-an-advertiser.md" class="xref">advertiser</a> and a
seamless <a href="create-an-insertion-order.md" class="xref">insertion
...
<b>Note:</b> The settings you select on the
...
<b>Note:</b> All pacing is ignored for deal
line items.
...
- **Ad Type** - Select the type of ad you plan to use. Possible values
  ...
  **Native**.
  ...
  Criteria \>  Media
  Type (see <a
  href="create-a-deal-line-item.md#ID-000010a2__p-1d967336-ee61-433f-8a56-89cb5fb8e4c9"
...
- **Roadblocking** - Optionally, you can enable programmatic roadblocks
  ...
  <b>Note:</b> Programmatic roadblocking is a
...
- Budget Type - Budget is set on the
  ...
  <b>Note:</b> When you create a deal line
...
3.  Click Edit under
    ...
    <b>Note:</b> For multi-buyer deals, see
...
7.  Enter a description for your deal in
    ...
    <b>Note:</b> This description is visible
    to buyers.
...
<b>Note:</b> All budget types are optional.
...
href="create-a-deal-line-item.md#ID-000010a2__p-152f5d10-f296-4df1-a6a3-fc2be77fcecc"
...
- Allowlist: Select an allowlist you
  ...
  or <a href="inventory-targeting-ali.md" class="xref">create an
...
<b>Note:</b> The use of Inventory Lists (e.g.,
...
- Video content specifics such as video program type, delivery method,
  ...
  information, see <a href="video-content-targeting.md" class="xref"
...
- You can now target Key/Values rather than Query String Segments:
  ...
  <b>Note:</b> Key/Values are reportable;
...
<b>Note:</b>
See <a href="override-ad-quality-settings-on-a-deal.md"
...
- Trust Level (see Trust Level section
  in <a href="override-ad-quality-settings-on-a-deal.md"
  class="xref">Override Ad Quality Settings on a Deal</a> for detailed
  setup information)
- Creative Category
...
- Media Type: Select the media types
  ...
  <b>Note:</b> Limiting the media types of
