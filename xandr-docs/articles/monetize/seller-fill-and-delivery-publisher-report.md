...
Note: This report only provides
...
Note: **For video sellers only:** As a
...
<img
src="../images/seller-fill-and-delivery-network-report/Create_Seller_Filler_and_Delivery_Explanatory_Graphic.jpg"
class="image" />
...
<thead class="thead">
<tr class="header row">
<th id="ID-000068b4__entry__1" class="entry">Column</th>
<th id="ID-000068b4__entry__2" class="entry">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__1">Filtered Requests</td>
<td class="entry" headers="ID-000068b4__entry__2">Ad requests filtered
pre-bid by Xandr for inventory quality.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__1">Imps (kept)</td>
<td class="entry" headers="ID-000068b4__entry__2">An impression where a
managed advertiser's creative serves on a managed publisher's site.</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__1">Imps (resold)</td>
<td class="entry" headers="ID-000068b4__entry__2">An impression that is
resold to a third-party buyer.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__1">Defaults</td>
<td class="entry" headers="ID-000068b4__entry__2">Ad requests where a
default creative served because there were no valid bids.</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__1">Video Player
Errors</td>
<td class="entry" headers="ID-000068b4__entry__2">Errors reported from
the video player after the VAST XML has been delivered.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__1">Video Default
Errors</td>
<td class="entry" headers="ID-000068b4__entry__2">Errors reported from
the video player when a default creative should have served.</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__1">Bid Sent No
Reponses</td>
<td class="entry" headers="ID-000068b4__entry__2">Ad requests sent from
Xandr to external ad servers for a secondary
auction that did not result in a win, or Xandr
auctions using Xandr's seller tags (AST) where
an auction was held but the impression tracker failed to notify <span
class="ph">Xandr servers. For more information, see the <a
href="https://docs.xandr.com/bundle/seller-tag/page/seller-tag/seller-tag.html"
class="xref" target="_blank">Seller Tag</a> page.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__1">Default No
Reponses</td>
<td class="entry" headers="ID-000068b4__entry__2">Ad requests where a
...
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__1">PSAs or Blanks</td>
<td class="entry" headers="ID-000068b4__entry__2">The number of blanks
or PSAs served. It can also include ad requests where no bids were
submitted by Xandr, such as unfilled header
bidding requests.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__1">Total Ad Requests</td>
<td class="entry" headers="ID-000068b4__entry__2">The total number of ad
...
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__1">Total Ad
Responses</td>
<td class="entry" headers="ID-000068b4__entry__2">The total number of ad
...
<thead class="thead">
<tr class="header row">
<th id="ID-000068b4__entry__25" class="entry">Name</th>
<th id="ID-000068b4__entry__26" class="entry">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__25">Deal</td>
<td class="entry" headers="ID-000068b4__entry__26">The deal associated
with the transaction for the impression.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__25">Placement Group</td>
<td class="entry" headers="ID-000068b4__entry__26">The placement group
where the impression occurred.</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__25">Placement</td>
<td class="entry" headers="ID-000068b4__entry__26">The placement on
which the impression occurred.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__25">Country</td>
<td class="entry" headers="ID-000068b4__entry__26">The country in which
the impression occured.</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__25">Supply Type</td>
<td class="entry" headers="ID-000068b4__entry__26">The seller-classified
channel to denominate supply in terms of web, mobile-optimized web, and
mobile app impressions. Possible values:
<ul>
<li>Web Placements</li>
<li>Mobile Web Placements</li>
...
<thead class="thead">
<tr class="header row">
<th id="ID-000068b4__entry__37" class="entry">Name</th>
<th id="ID-000068b4__entry__38" class="entry">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__37">Deal</td>
<td class="entry" headers="ID-000068b4__entry__38">The deal associated
with the transaction for the impression.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__37">Supply Type</td>
<td class="entry" headers="ID-000068b4__entry__38">The seller-classified
channel to denominate supply in terms of web, mobile-optimized web, and
mobile app impressions. Possible values:
<ul>
<li>Web Placements</li>
...
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__37">Country</td>
<td class="entry" headers="ID-000068b4__entry__38">The country in which
the impression occured.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__37">Ad Request Call
Type</td>
<td class="entry" headers="ID-000068b4__entry__38">The type of handler
that was used to send the impression to Xandr
(e.g., ttj, ut, mob, ptv, openrtb)</td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__37">Site Domain</td>
<td class="entry" headers="ID-000068b4__entry__38">For web or mobile web
impressions, the domain where the impression occurred. There is one
additional value that may appear in place of a domain, specically: <code
class="ph codeph">"---"</code> This means that we didn't receive a valid
domain as the referrer. For example, the domain may be blank or
otherwise malformed.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__37">Mobile
Application</td>
<td class="entry" headers="ID-000068b4__entry__38">For mobile app
...
too few impressions to be included in reporting.</p></td>
</tr>
<tr class="odd row">
<td class="entry" headers="ID-000068b4__entry__37">Placement Group</td>
<td class="entry" headers="ID-000068b4__entry__38">The name and ID of
the placement group where the impression occurred.</td>
</tr>
<tr class="even row">
<td class="entry" headers="ID-000068b4__entry__37">Placement</td>
<td class="entry" headers="ID-000068b4__entry__38">The name and ID of
...
href="working-with-impression-and-click-trackers.html"
...
5.  Choose a delivery option. Once you've selected your filters and
    ...
    - <span id="ID-000068b4__d10e107">**Export, send results via
...
6.  <span id="ID-000068b4__d10e136">Click Run
