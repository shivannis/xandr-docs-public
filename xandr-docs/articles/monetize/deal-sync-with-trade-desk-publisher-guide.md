...
Description : Note: This feature is in **Beta**. It
---
...
deals with Trade Desk, but this requires buyers to manually register
publisher deals in the Trade Desk user interface. (Details of the manual
process can be found in <a
href="https://docs.xandr.com/bundle/xandr-bidders/page/trade-desk-buying-guide.html"
class="xref" target="_blank">Trade Desk Buying Guide</a>.) The manual
process of setting up deals can result in delays and issues due to human
error.
...
<img src="../images/trade-desk/image1.png"
id="ID-00007677__image-c4b291d0-38af-4749-a159-d063949f3464"
...
<img src="../images/trade-desk/imagee2.png"
id="ID-00007677__image-a7641327-7a18-4fbb-84d4-122935fca748"
class="image imagecenter" />
