...
Description : The Network Video Analytics report can be used
to view video event metrics across multiple buyers and sellers for a
network member.
---
...
The Network Video Analytics report can be used
to view video event metrics across multiple buyers and sellers for a
network member.
...
href="creative-frequency-and-recency-report.html" class="xref">Creative
...
<td class="entry colsep-1 rowsep-1" headers="ID-00002b8f__entry__274">A
default creative served because no line item or
campaign bid or no other creative was eligible.</td>
</tr>
<tr class="odd row">
<td class="entry colsep-1 rowsep-1"
