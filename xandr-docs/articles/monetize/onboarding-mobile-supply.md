...
<b>Warning:</b> Sellers using the `/mob` or
...
![server vs client](media/server-vs-client.png)
...
<b>Tip:</b> We recommend creating separate
...
see our <a href="mobile-ad-call-reference.md" class="xref">Mobile Ad
Call Reference</a>.</td>
</tr>
<tr class="even row">
...
<b>Tip:</b> For a complete list of the query
...
see <a
href="mobile-sdk/android-sdk-integration.md"
class="xref" target="_blank">Android SDK Integration</a> and <a
href="mobile-sdk/ios-sdk-integration.md"
