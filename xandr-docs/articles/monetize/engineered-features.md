...
constantly refining their predictions based on incoming data. Now you can also use them as building blocks in [custom bidding models](advanced-ads-toolset/custom-models.md).
...
For more information on how video viewability is measured, see [Introduction to Viewability](introduction-to-viewability.md)<a href="" class="xref"></a>. For information on how to use these viewability predictions with AppNexus Programmable Bidder, see [Bonsai Features](data-science-toolkit/bonsai-language-features.md) and [Smart Leaves](data-science-toolkit/bonsai-smart-leaves.md).
