...
![xbox-a]("media/xbox-bestpractices-a.png)
...
- Do not use CTAs that reference direct interaction with the placement
 ...
 ![xbox-b]("media/xbox-bestpractices-b.png)

- Do not use CTAs that reference direct interaction with the placement
  (“Click Here”, “Click Now!” etc.).

![xbox-c]("media/xbox-bestpractices-c.png)
...
- Do not mimic system tiles on the dash (i.e. Xbox green tiles with
 ...
 ![xbox-d]("media/xbox-bestpractices-d.png)
...
![banner recommendation](media/banner-recommendations.png)
