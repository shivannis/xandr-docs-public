...
<a href="default-psas.html" class="xref">Default PSAs</a>, you can set
---
...
Note: You cannot assign default
...
Note: If no pre-existing default
...
- **File** - Browse for the file to upload. The following file formats
  ...
  Note: If your account is enabled for
...
Note: In the event that a placement is
sizeless and you have not selected a default creative for all possible
sizes, a <a href="default-psas.html" class="xref">Default PSAs</a> may
...
- **Tag** and **Tag Type** - For a third-party tag, enter the HTML or
  ...
  the `${REFERER_URL}` <a href="creative-macros.html" class="xref"
...
- **Size** - Select the dimensions of the default creative. If you don't
  ...
  Note: In the event that a placement
  is sizeless and you have not selected a default creative for all
  possible sizes, a
  <a href="default-psas.html" class="xref">Default PSAs</a> may serve
...
<a href="default-psas.html" class="xref">Default PSAs</a>, this could be
...
See <a href="serve-default-creatives-instead-of-psas.html"
...
- <a href="serve-default-creatives-instead-of-psas.html"
