...
Description : Note: The descriptions in this topic
...
Note: The descriptions in this topic
apply only to Standard Line Items (not available in Invest). A new
...
publishers, see
<a href="buy-mobile-inventory-directly-from-a-publisher.html"
...
- **Targeting** - What specific inventory you want to run on and how
  ...
  Note: Inventory Quality does not
...
Note: changing the campaign type will
...
- **Flight Dates** - Set the start for the campaign and set an end date
  ...
  Note: If flight dates are set for the
...
- **Daily** - This is the budget that you are willing to spend on any
  ...
  - **Pace Lifetime Budget** - Select this option to spread your
    ...
    - The system is not able to pace its spending if it does not have a
      ...
      practices, see <a href="lifetime-pacing.html" class="xref"
...
6 of
<a href="create-a-standard-line-item.html" class="xref">Create a Line
Item</a>.
...
- **Optimize to a predicted CPA goal**
  ...
  - **Bid at most $ \_\_ CPM in Learn Phase** - When your campaign
    ...
    bids. Note: When you set both a cap for learn bids and a max CPM for
...
- **Optimize to a predicted CPC goal**
  ...
  - **Bid at most $ \_\_ CPM in Learn Phase** - When your campaign
    ...
    inventory sources that are worth higher prices. Note: When you set
...
Note: If using frequency targeting for
...
Note: The majority of mobile supply is
