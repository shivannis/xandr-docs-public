...
and <a href="create-a-deal-campaign.html" class="xref">Create a Deal
Campaign</a>



Note: Before you create a custom deal,
...
Note: Clients of different types may
...
Note: If you are assigning a deal to a
...
<a href="curated-deals.html" class="xref">Curated Deals</a> for more
information.
...
- **End Date -** Enter the end date for the deal. This information is
  ...
  Note: Start and end date use the UTC
...
- **Ask Price** - Check the **Specify a price for this deal** checkbox
  ...
  - **Specify an ask price** - Select this if you would like to enter a
...
Tip: Remember, by default, your network
...
Tip: If you allow private media types,
...
- **URL** - Determines whether the URL of the site is visible to the
  ...
  - **Hidden** - Buyer cannot view the URL.
    ...
    Note: Keep in mind that if you hide
...
Warning: **For members that have VAST
