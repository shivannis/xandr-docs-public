...
An example of a Xandr Click Tracker URL is
<a href="https://nym1-ib.adnxs.com/click2?" class="xref"
target="_blank">https://nym1-ib.adnxs.com/click2?</a>.
...
creative may be configured with blocklists on Xandr-domains that control
where the creative is allowed to render. Ensure that your
server-configurations have no blocks on the following domains:
<ul>
...
<td class="entry align-left colsep-1 rowsep-1"
headers="click-tracking-test-outcomes__table-ccb20604-9864-4c7d-a410-dd25ec15b6f3__entry__2"><ul>
<li>The creative might not be clickable. The recommandation would be to
verify the creative's behavior and update it if it is needed.</li>
<li>The creative only has a specific area that is clickable: Our Click
Track Test tool might not be able to detect this. If this is the case,
please manually test the creative to see if Xandr click tracker fires
while a click is initiated. All the instructions are on this <a
href="monetize_monetize-standard/test-click-tracking-manually.md"
class="xref" target="_blank">page</a></li>
<li>Xandr performs click-track testing from a Firefox Browser. So, if
your creative fails to click on Firefox environments, it will fail the
test. Ensure that your creative renders and is clickable on all
supported browsers such as Chrome, Firefox, Safari, and Edge.</li>
</ul></td>
</tr>
<tr class="odd row">
<td class="entry align-left colsep-1 rowsep-1"
...
that Xandr's click macro is properly embedded within your creative's tag
and that the creative clicks through to a new tab and/or window.</td>
</tr>
<tr class="even row">
<td class="entry align-left colsep-1 rowsep-1"
headers="click-tracking-test-outcomes__table-ccb20604-9864-4c7d-a410-dd25ec15b6f3__entry__1">Xandr's
Click tracker URL did not fire</td>
<td class="entry align-left colsep-1 rowsep-1"
headers="click-tracking-test-outcomes__table-ccb20604-9864-4c7d-a410-dd25ec15b6f3__entry__2">Ensure
that the Xandr click macro is properly embedded in your creative's tag.
This macro is a placeholder value for Xandr's click-tracker URL, which
is used to measure clicks on Xandr's Server.</td>
</tr>
<tr class="odd row">
<td class="entry align-left colsep-1 rowsep-1"
headers="click-tracking-test-outcomes__table-ccb20604-9864-4c7d-a410-dd25ec15b6f3__entry__1">Click
Tracker URL fired before click</td>
<td class="entry align-left colsep-1 rowsep-1"
headers="click-tracking-test-outcomes__table-ccb20604-9864-4c7d-a410-dd25ec15b6f3__entry__2">Please
verify if the Xandr click macro is placed before the
<strong>source</strong> URL either of the creative iFrame or Javascript
tag, rather than adding it into the query string.
<pre id="click-tracking-test-outcomes__codeblock_vxs_rsm_gzb"
class="pre codeblock"><code>&lt;script src=&quot;${CLICK_URL}http://ad.mysampleadserver.com/myAdOnAppNexus/Ad-MediumRectangle-300x250&quot;type=&quot;text/javascript&quot;&gt;&lt;/script&gt;</code></pre>
<p>This means that every time the creative loads, it will load Xandr
click URL along with the creative entire source code, causing clicks to
be tracked 100% of the time. Please, ensure that the Xandr click Macro
is placed in the query string.</p></td>
</tr>
</tbody>
</table>
