...
| Conversion Pixel | Yes | The conversion pixel which was fired in this conversion event. For more information about [conversion pixels](working-with-conversion-pixels.md), see Working with Conversion Pixels. |
