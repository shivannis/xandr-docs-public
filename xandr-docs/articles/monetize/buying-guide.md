...
- <a href="automatic-archiving-of-buy-side-objects.md"
  class="xref">Automatic Archiving of Buy-Side Objects</a>: To avoid
...
- <a href="working-with-insertion-orders.md" class="xref">Working with
  Insertion Orders</a>:  Insertion orders offer an
...
- <a href="working-with-campaigns.md" class="xref">Working with
  Campaigns</a>: If you use standard line items, you can set up
  ...
  Items (ALI)</a> include this information, so separate campaigns aren't
  needed.)
...
- <a href="budgeting-and-pacing.md" class="xref">Budgeting and
  Pacing</a>: Budgeting allows you to determine how much money you will
...
- <a href="working-with-creatives.md" class="xref"
  ...
  with Creatives</a>: The Xandr platform enables
...
- <a href="buying-microsoft-inventory.md" class="xref">Buying Microsoft
  Inventory</a>: This guide provides information about buying inventory
...
- <a href="native-inventory-seller-specifications.md"
  class="xref">Native Inventory Seller Specifications</a>: Buying native
  inventory requires understanding detailed seller requirements.
- <a href="campaign-monitor.md" class="xref">Campaign Monitor</a>: The
