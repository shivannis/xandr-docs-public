...
Note: All VPAID creatives will be
...
- The URL may lead to a rotating, deactivated, or targeting-enabled tag
  ...
  <img src="../images/vast-check/unable-to-run.png" class="image" />
...
- Reach out to the tag provider to add the missing duration information
  ...
  <img src="../images/vast-check/video-duration.jpg"
  id="ID-000070b8__image-9a46ea6b-2f26-43b7-b0fa-e9be5eacb12b"
  class="image" />
...
- Reach out to the tag provider to update the creative with at least one
  ...
  <img src="../images/vast-check/video-formats.png"
  id="ID-000070b8__image-517990b5-1904-463a-b7e7-6818b731d631"
  class="image" />

  Sample XML with recommended VPAID formats:

  <img src="../images/vast-check/media-files.png"
  id="ID-000070b8__image-65fa1ec6-bb7d-40f3-9a46-f0cca5bc3db4"
  class="image" />
...
<a href="vast-check.html#ID-000070b8__ID-00007156" class="xref">No video
...
<img src="../images/vast-check/wrapper-vast.png" class="image" />
