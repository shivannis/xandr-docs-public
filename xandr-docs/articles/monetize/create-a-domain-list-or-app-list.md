...
You can create a new domain list or app list by uploading a text file,
or by entering domains or apps manually into
Monetize. This page walks you through the
process. For details about creating a list by duplicating an existing
list, see
...
2.  Click Create
    New  \>  Domain List
    OR select the Domain Lists tab and
    click + New.
3.  In the **New Domain List** dialog, enter the **Name** and
    **Description** of the domain list.
4.  In the Domains section, either:
    - Select Enter text and copy and
      paste domains into the text area OR
    - Select Upload a file, click
      Select File, and select text
      file to upload. **<b>Note:</b>** Excel files are not allowed.
5.  Click Save. To target this domain
    list in a campaign, see
...
Domains and subdomains must be separated by a comma, space, or line
break. Examples of acceptable formatting include:
...
2.  Click Create
    New  \>  App List OR
    select the App Lists tab and click
    + New.
3.  In the **New App List** dialog, enter the **Name** and
    **Description** of the app list.
4.  In the Apps section, either:
    - Select Enter text and copy and
      paste app IDs into the text area *OR*
    - Select Upload a file, click
      Select File, and select text
      file with app IDs to upload.
      

      <b>Note:</b> The app IDs should be
      separated by commas or line breaks

      
5.  Click Save. To target this app
    list in a campaign, see
