...
Note: For more information on floors
...
- **Floor Optimization** - Instead of entering a soft floor, you can
  ...
  Note: Soft floors are not available
...
- **Floor Price Applies To** - Select the type of bids that the floor
  ...
  Note: The rule will not apply to
...
<a href="floor-rule-targeting.html" class="xref">Floor Rule
