...
![buy side object hierarchy](media/buy-side-object-hierarchy.png)


Overview and Diagram (Augmented Line Item)

![ali](media/ali-buy-side-object-hierarchy.png)

>

Key differences of an
<a href="augmented-line-items-ali.md" class="xref">Augmented Line Item
...
(<a href="set-seller-defaults.md" class="xref">seller settings</a>),
you create lists of domains and apps for efficient allowlist or
blocklist targeting in campaigns
(<a href="working-with-targeting-lists.md" class="xref">targeting
...
- <a href="working-with-line-items.md" class="xref">Standard Line
...
The <a href="working-with-campaigns.md" class="xref">campaign</a>
...
![sell side object hierarchy](media/sell-side-object-hierarchy.png)


Network

The <a href="network-guide.md" class="xref">network</a> represents
...
Your
<a href="working-with-network-ad-quality.md" class="xref">network ad
...
template</a> or
<a href="create-a-custom-profile.md" class="xref">custom profile</a>;
...
your own
<a href="manage-custom-content-categories.md" class="xref">custom
...
A <a href="selling-deals.md" class="xref">package</a> is a pre-made
...
A <a href="create-a-custom-deal.md" class="xref">deal</a> is a one-off
custom package for a specific buyer.

Publisher

A <a href="working-with-publishers.md" class="xref">publisher</a>
...
A
<a href="working-with-payment-rules.md" class="xref">payment rule</a>
...
<a href="create-payment-rules.md" class="xref">conditional payment
...
A <a href="working-with-placement-groups.md" class="xref">placement
...
A <a href="working-with-placements.md" class="xref">placement</a>
