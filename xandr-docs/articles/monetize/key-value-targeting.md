...
<a href="key-value-targeting.md#ID-0000119e__ID-00001332"
...
![UI Operator](media/uioperatordiagram.png)
...
- The group on the left side of the tree represents the last part of our
  ...
  ![UI Operator](media/uioperatordiagramstep-a.png)
...
4.  Click Done. (Be careful to click
    ...
    ![UI Operator](media/uioperatordiagramstep-b.png)
...
9.  Click Done.
    ...
    ![UI KV Target](media/media/uikvtarget-a.png)
   ...
   ![UI Operator](media/uioperatordiagramstep-c.png)
    ...
    **and**.
    ...
    <![UI Operator group](media/uioperatordiagramsgroup-a.png)
   ...
   ![UI Operator](media/uioperatordiagramstep-f.png)

    Enter the key/value target for the first part of our right-side
    group.

   ![UI Operator](media/uioperatordiagramstep-d.png)
...
13. Click Done.
   ...
   ![UI Operator](media/uioperatordiagramstep-e.png)
...
18. Click Done.
   ...
   ![Key value](media/keyvaluedialogexp.png)
...
![Numeric KV](media/numerickvtargeting.png)
...
- Accented characters are considered unique. For example, if `båtvagn`
  ...
  <a href="key-value-targeting.md#ID-0000119e__p_aff_c2k_xkb"
