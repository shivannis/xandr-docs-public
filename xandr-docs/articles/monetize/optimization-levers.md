...
Check the Defer to Line Item revenue with a
...
Note: Each of the following options
...
- **Average RPM Bid** - Select this option to use the average winning
  ...
  <img src="../images/optimization-levers/learn-override-avg-RPM.jpg"
  class="image" />
...
- **Base CPM Bid** - You can specify the CPM bid amount and use that
  ...
  <img src="../images/optimization-levers/learn-override-base-RPM.jpg"
  class="image" />
...
- **Bid Multiplier** - You can multiply the optimization-determined
  ...
  <img
  src="../images/optimization-levers/learn-override-bid-multiplier.jpg"
  class="image" />

  

  Warning: The more data you acquire,
...
campaign, see
<a href="segment-modifier.html" class="xref">Segment Modifier</a>.



Note: Do not set a segment price and
...
Note: This setting is not in the
...
<img src="../images/optimization-levers/cadence-modifier.png"
class="image" />
...
- <a href="optimization-buying-strategies.html" class="xref">Optimization
  Buying Strategies</a>
- <a href="targeted-learn-faq.html" class="xref">Targeted Learn FAQ</a>
- <a href="what-is-an-optimization-node.html" class="xref">What is an
  Optimization Node?</a>
