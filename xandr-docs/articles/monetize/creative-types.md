...
Description : You can host a variety of creative types with
ms.date: 10/28/2023
...
<b>Note:</b> Xandr
provides standard creative templates for all supported media types, such
as expandables and intersitials. You can also create your own custom
