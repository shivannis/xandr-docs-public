...
<b>Tip:</b> If you need an introduction to
...
![line item](media/line-item-type.png)
...
<b>Warning:</b> Currently, to use a guaranteed
delivery line item, you need to pair it with a
<a href="create-a-legacy-insertion-order.md" class="xref">legacy
...
![impressions](media/impressions.png)
...
- The <a href="guaranteed-delivery-pacing.md" class="xref">Guaranteed
...
<b>Important:</b> **vCPM and the Exclusive
Delivery Type**
...
- One time allocation - Applies the
  ...
  <b>Note:</b> The line item's flight dates
...
<b>Note:</b> Guaranteed delivery line items
...
<b>Important:</b> Not all campaign settings
...
![check](media/check-availability.png)
