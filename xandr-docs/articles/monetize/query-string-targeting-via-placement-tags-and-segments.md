...
**Query string segments** make it easier to manage unique segment
...
- <a
  href="query-string-targeting-via-placement-tags-and-segments.md#ID-0000114a__p_mgk_wjj_3kb"
  class="xref">Add a Query String Segment</a>
- <a
  href="query-string-targeting-via-placement-tags-and-segments.md#ID-0000114a__p_rs2_xjj_3kb"
...
2.  Click Create Segment. Provide the
    ...
    - **Name**: Type a descriptive name for your reference (for example,
      ...
      <b>Warning:</b> If the Parameter (Key)
    ...
    - **Values**: Select Text,
      ...
      <b>Tip:</b> You can use an asterisk at
      ...
      <b>Important:</b> When you choose the
...
<b>Note:</b> For a single query string
...
- **Name**: Type a descriptive name for your reference (for example,
  ...
  <b>Warning:</b> If the Parameter (Key) name
...
<b>Tip:</b> You can reuse a query string key
...
<b>Note:</b> Unlike query string parameters,
...
- <a
  href="query-string-targeting-via-placement-tags-and-segments.md#ID-0000114a__p_o23_ymj_3kb"
  class="xref">Getting to Segment Targeting</a>
- <a
  href="query-string-targeting-via-placement-tags-and-segments.md#ID-0000114a__p_ic4_ymj_3kb"
  class="xref">Targeting a Text Query String Segment</a>
- <a
  href="query-string-targeting-via-placement-tags-and-segments.md#ID-0000114a__p_qjv_zmj_3kb"
...
<b>Tip:</b> This section describes how to
target query string segments. For more general information about segment
targeting, see <a href="segment-targeting.md" class="xref"
title="You can target users within segments by using Boolean expressions. Users get added to segments after they&#39;ve viewed or clicked a particular creative.">Segment
Targeting</a>.
...
![page properties](media/page-properties-query-string.png)
