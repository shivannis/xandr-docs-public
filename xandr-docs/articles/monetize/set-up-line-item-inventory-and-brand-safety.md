...
2.  Set your Managed
    ...
    Note: This field will only appear
...
3.  Set the Inventory
    ...
    Tip: The inventory type can also be
...
4.  Select a member-level or advertiser-level
    ...
    checkbox has been selected at the Network
...
5.  Select a member-level or advertiser-level
    ...
    - If the Require for all Line
      ...
      Network level for a particular allowlist,
