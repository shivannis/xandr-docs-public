...
| `content_categories` | array of objects | A list of available categories that you can apply to publishers, sites, and placements. Can be customized by the member. [The array is of this format](#content-categories-array-format). |  |  |  |  |  |  |  |  |  |
