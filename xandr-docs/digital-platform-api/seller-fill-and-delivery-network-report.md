...
| `openrtb2_request_subdomain` | string | No | `wrapper-emea` | The subdomain of the URL that the OpenRTB2 ad request was sent to. <br>**Note**: <br>**Note**: This value is blank for non-OpenRTB2 call types. A blank value in OpenRTB2 indicates no subdomain was used.|
