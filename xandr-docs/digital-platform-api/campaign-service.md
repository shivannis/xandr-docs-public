...
| `bid_multiplier` | double | The value by which to multiply the learn bid. This can be used for our algorithm's default learn bid or an override learn bid when `learn_override_type` is `"venue_average_cpm_bid"`. This value cannot be greater than `10.0`.<br>**Default:** `1.0` |k
