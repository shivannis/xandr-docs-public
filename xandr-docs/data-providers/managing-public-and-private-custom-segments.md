...
<span class="ph">Xandr</span>. Both the data provider and data buyer
...
<span class="notetitle">Note:</span> <span class="ph">Xandr</span> will
automatically share this segment to all Data Marketplace buyers.
...
specific <span class="ph">Xandr</span>members.
...
1.  Modify the segment to "private" using
    ...
    **Map the segment to a pricing category and set segment to public**
    ...
    <span class="notetitle">Note:</span> Xandr will stop sharing this
