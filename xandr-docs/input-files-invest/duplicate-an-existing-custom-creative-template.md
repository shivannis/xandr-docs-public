...
9.  <span id="duplicate-an-existing-custom-template__d78e33"
    class="ph cmd">Expand the Custom
    macros section if necessary.
10. <span id="duplicate-an-existing-custom-template__d78e42"
    ...
    following:
    <div id="duplicate-an-existing-custom-template__d78e51"
...
11. Repeat step 10 to add each individual custom
    macro.
12. Update the details for any of the existing custom
    macros if necessary.
