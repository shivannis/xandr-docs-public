...
1.  <a href="navigate-to-the-create-a-new-line-item-screen-invest.md"
    class="xref"
...
12. <a href="enable-third-party-measurement-features-on-a-line-item.md"
    class="xref"
    title="Augmented line items can integrate a range of third-party measurement features from vendors such as Nielsen to gain insight into your delivery and audience reach.">Enable
    Third-Party Measurement Features on a Line Item</a>
...
13. <a href="configure-a-programmable-split.md" class="xref"
...
14. <a href="apply-a-partner-fee-to-a-line-item.md" class="xref"
...
15. <a href="add-reporting-labels-and-comments-to-a-line-item.md"
    class="xref"
