...
| `serving_domain` | array of strings | Used when generating tags for selling members. (i.e. [mycompany.adnxs.com](https://mycompany.adnxs.com/) instead [ib.adnxs.com](https://ib.adnxs.com/)). <br>`"serving_domain": {"cname": null,"type": null}`<br> Read only. |
