...
1. Create an [Azure storage account](/articles/storage/common/storage-account-create.md) which will host one or more storage containers.
...
1. **Setup**. Enter the information in the table below and click **Save**:
    ...
    | Setting | Description |
    |---|---|
    | **Storage Account** | Name of the [Azure storage account](/articles/storage/common/storage-account-create.md) created in step 1. |
